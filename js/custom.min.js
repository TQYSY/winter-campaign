...
function() {
            ...
            "down" !== t || jQuery(this.element).hasClass("probootstrap-animated") || (e++, jQuery(this.element).addClass("item-animate"), setTimeout(function() {
                jQuery("body .probootstrap-animate.item-animate").each(function(e) {
                    ...
                    setTimeout(function() {
                        ...
                        "fadeIn" === e ? t.addClass("fadeIn probootstrap-animated") : "fadeInLeft" === e ? t.addClass("fadeInLeft probootstrap-animated") : "fadeInRight" === e ? t.addClass("fadeInRight probootstrap-animated") : t.addClass("fadeInUp probootstrap-animated"),
    ...
    r = function(e) {
        for (var t = function(e) {
            for (var t, n, a, i, r = e.childNodes,
            o = r.length,
            s = [], u = 0; u < o; u++) 1 === (t = r[u]).nodeType && (n = t.children[0], console.log(t), a = n.getAttribute("data-size").split("x"), i = {
        ...
        a = function(e, n, a, i) {
            ...
            i) if (r.galleryPIDs) {
                for (var u = 0; u < o.length; u++) if (o[u].pid == e) {
                    r.index = u;
                    break
                }
        ...
        i = document.querySelectorAll(e), r = 0, o = i.length; r < o; r++) i[r].setAttribute("data-pswp-uid", r + 1),
        i[r].onclick = function(e) { (e = e || window.event).preventDefault ? e.preventDefault() : e.returnValue = !1;
            ...
            if (i) {
                for (var r, o = i.parentNode,
                s = i.parentNode.childNodes,
                u = s.length,
                l = 0,
                d = 0; d < u; d++) if (1 === s[d].nodeType) {
                    if (s[d] === i) {
                        r = l;
                        break
                    }
        ...
        var s = function() {
            ...
            for (var n = e.split("&"), a = 0; a < n.length; a++) if (n[a]) {
                var i = n[a].split("=");
    ...
    jQuery(function() {
        a(),
        i(),
        jQuery(".probootstrap-gallery").length > 0 && r(".probootstrap-gallery"),
        o(),
        s(),
        u(),
        l(),
