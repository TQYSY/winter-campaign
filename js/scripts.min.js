...
function(t, e) {
    ...
    function n(t, e, i) {
        if (dt.isFunction(e)) return dt.grep(t,
        function(t, n) {
        ...
        if ("string" == typeof e) {
            if (Tt.test(e)) return dt.filter(e, t, i);
            e = dt.filter(e, t)
        }
        return dt.grep(t,
        function(t) {
    ...
    function a() { (it.addEventListener || "load" === t.event.type || "complete" === it.readyState) && (r(), dt.ready())
    }
    function l(t, e, i) {
        if (void 0 === i && 1 === t.nodeType) {
            ...
            if ("string" == typeof(i = t.getAttribute(n))) {
                try {
                    i = "true" === i || "false" !== i && ("null" === i ? null: +i + "" === i ? +i: Ot.test(i) ? dt.parseJSON(i) : i)
                } catch(t) {}
                dt.data(t, e, i)
            } else i = void 0
        }
    ...
    function c(t, e, i, n) {
        if (At(t)) {
            var o, s, r = dt.expando,
            a = t.nodeType,
            l = a ? dt.cache: t,
            u = a ? t[r] : t[r] && r;
            if (u && l[u] && (n || l[u].data) || void 0 !== i || "string" != typeof e) return u || (u = a ? t[r] = et.pop() || dt.guid++:r),
            l[u] || (l[u] = a ? {}: {
                toJSON: dt.noop
            }),
            "object" != typeof e && "function" != typeof e || (n ? l[u] = dt.extend(l[u], e) : l[u].data = dt.extend(l[u].data, e)),
            s = l[u],
            n || (s.data || (s.data = {}), s = s.data),
            void 0 !== i && (s[dt.camelCase(e)] = i),
            "string" == typeof e ? null == (o = s[e]) && (o = s[dt.camelCase(e)]) : o = s,
            o
        }
    }
    function h(t, e, i) {
        if (At(t)) {
            ...
            if (r[a]) {
                if (e && (n = i ? r[a] : r[a].data)) {
                    dt.isArray(e) ? e = e.concat(dt.map(e, dt.camelCase)) : e in n ? e = [e] : (e = dt.camelCase(e), e = e in n ? [e] : e.split(" ")),
                    o = e.length;
                    for (; o--;) delete n[e[o]];
                    if (i ? !u(n) : !dt.isEmptyObject(n)) return
                } (i || (delete r[a].data, u(r[a]))) && (s ? dt.cleanData([t], !0) : ct.deleteExpando || r != r.window ? delete r[a] : r[a] = void 0)
            }
        }
    }
    function d(t, e, i, n) {
        ...
        c = (dt.cssNumber[e] || "px" !== u && +l) && Lt.exec(dt.css(t, e));
        if (c && c[3] !== u) {
            u = u || c[3],
            i = i || [],
            c = +l || 1;
    ...
    function f(t, e) {
        ...
        if (!s) for (s = [], i = t.childNodes || t; null != (n = i[o]); o++) ! e || dt.nodeName(n, e) ? s.push(n) : dt.merge(s, f(n, e));
        return void 0 === e || e && dt.nodeName(t, e) ? dt.merge([t], s) : s
    }
    function m(t, e) {
    ...
    function v(t, e, i, n, o) {
        for (var s, r, a, l, u, c, h, d = t.length,
        v = p(e), y = [], w = 0; d > w; w++) if ((r = t[w]) || 0 === r) if ("object" === dt.type(r)) dt.merge(y, r.nodeType ? [r] : r);
        else if (Ut.test(r)) {
            for (l = l || v.appendChild(e.createElement("div")), u = (Ft.exec(r) || ["", ""])[1].toLowerCase(), h = qt[u] || qt._default, l.innerHTML = h[1] + dt.htmlPrefilter(r) + h[2], s = h[0]; s--;) l = l.lastChild;
            if (!ct.leadingWhitespace && Wt.test(r) && y.push(e.createTextNode(Wt.exec(r)[0])), !ct.tbody) for (s = (r = "table" !== u || Bt.test(r) ? "<table>" !== h[1] || Bt.test(r) ? 0 : l: l.firstChild) && r.childNodes.length; s--;) dt.nodeName(c = r.childNodes[s], "tbody") && !c.childNodes.length && r.removeChild(c);
            for (dt.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(e.createTextNode(r));
        for (l && v.removeChild(l), ct.appendChecked || dt.grep(f(y, "input"), g), w = 0; r = y[w++];) if (n && dt.inArray(r, n) > -1) o && o.push(r);
        else if (a = dt.contains(r.ownerDocument, r), l = f(v.appendChild(r), "script"), a && m(l), i) for (s = 0; r = l[s++];) jt.test(r.type || "") && i.push(r);
        return l = null,
        v
    }
    function y() {
    ...
    function k(t, e) {
        if (1 === e.nodeType && dt.hasData(t)) {
            var i, n, o, s = dt._data(t),
            r = dt._data(e, s),
            a = s.events;
            if (a) {
                delete r.handle,
                r.events = {};
                for (i in a) for (n = 0, o = a[i].length; o > n; n++) dt.event.add(e, i, a[i][n])
            }
            r.data && (r.data = dt.extend({},
            r.data))
        }
    }
    function S(t, e) {
        var i, n, o;
        if (1 === e.nodeType) {
            if (i = e.nodeName.toLowerCase(), !ct.noCloneEvent && e[dt.expando]) {
                o = dt._data(e);
                for (n in o.events) dt.removeEvent(e, n, o.handle);
                e.removeAttribute(dt.expando)
            }
            "script" === i && e.text !== t.text ? (C(e).text = t.text, _(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), ct.html5Clone && t.innerHTML && !dt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && Rt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected: "input" !== i && "textarea" !== i || (e.defaultValue = t.defaultValue)
        }
    }
    function D(t, e, i, n) {
        e = ot.apply([], e);
        ...
        p = e[0],
        m = dt.isFunction(p);
        if (m || h > 1 && "string" == typeof p && !ct.checkClone && ee.test(p)) return t.each(function(o) {
            var s = t.eq(o);
            m && (e[0] = p.call(this, o, s.html())),
            D(s, e, i, n)
        });
        if (h && (u = v(e, t[0].ownerDocument, !1, t, n), o = u.firstChild, 1 === u.childNodes.length && (u = o), o || n)) {
            for (r = (a = dt.map(f(u, "script"), C)).length; h > c; c++) s = u,
            c !== d && (s = dt.clone(s, !0, !0), r && dt.merge(a, f(s, "script"))),
            i.call(t[c], s, c);
            if (r) for (l = a[a.length - 1].ownerDocument, dt.map(a, _), c = 0; r > c; c++) s = a[c],
            jt.test(s.type || "") && !dt._data(s, "globalEval") && dt.contains(l, s) && (s.src ? dt._evalUrl && dt._evalUrl(s.src) : dt.globalEval((s.text || s.textContent || s.innerHTML || "").replace(ne, "")));
            u = o = null
        }
        return t
    }
    function E(t, e, i) {
        for (var n, o = e ? dt.filter(e, t) : t, s = 0; null != (n = o[s]); s++) i || 1 !== n.nodeType || dt.cleanData(f(n)),
        n.parentNode && (i && dt.contains(n.ownerDocument, n) && m(f(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    function I(t, e) {
    ...
    function A(t) {
        var e = it,
        i = re[t];
        return i || ("none" !== (i = I(t, e)) && i || (se = (se || dt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (se[0].contentWindow || se[0].contentDocument).document).write(), e.close(), i = I(t, e), se.detach()), re[t] = i),
        i
    }
    function O(t, e) {
        return {
    ...
    function N(t, e) {
        for (var i, n, o, s = [], r = 0, a = t.length; a > r; r++)(n = t[r]).style && (s[r] = dt._data(n, "olddisplay"), i = n.style.display, e ? (s[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && zt(n) && (s[r] = dt._data(n, "olddisplay", A(n.nodeName)))) : (o = zt(n), (i && "none" !== i || !o) && dt._data(n, "olddisplay", o ? i: dt.css(n, "display"))));
    ...
    function $(t, e, i, n, o) {
        for (var s = i === (n ? "border": "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > s; s += 2)"margin" === i && (r += dt.css(t, i + $t[s], !0, o)),
        n ? ("content" === i && (r -= dt.css(t, "padding" + $t[s], !0, o)), "margin" !== i && (r -= dt.css(t, "border" + $t[s] + "Width", !0, o))) : (r += dt.css(t, "padding" + $t[s], !0, o), "padding" !== i && (r += dt.css(t, "border" + $t[s] + "Width", !0, o)));
        return r
    }
    function z(t, e, i) {
        var n = !0,
        ...
        s = he(t),
        r = ct.boxSizing && "border-box" === dt.css(t, "boxSizing", !1, s);
        if (0 >= o || null == o) {
            if ((0 > (o = de(t, e, s)) || null == o) && (o = t.style[e]), le.test(o)) return o;
            n = r && (ct.boxSizingReliable() || o === t.style[e]),
            o = parseFloat(o) || 0
        }
    ...
    function F(t, e) {
        ...
        o = 0;
        for (e = e ? 1 : 0; 4 > o; o += 2 - e) i = $t[o],
        n["margin" + i] = n["padding" + i] = t;
        return e && (n.opacity = n.width = t),
        n
    }
    function j(t, e, i) {
        for (var n, o = (H.tweeners[e] || []).concat(H.tweeners["*"]), s = 0, r = o.length; r > s; s++) if (n = o[s].call(i, e, t)) return n
    }
    function W(t, e) {
        var i, n, o, s, r;
        for (i in t) if (n = dt.camelCase(i), o = e[n], s = t[i], dt.isArray(s) && (o = s[1], s = t[i] = s[0]), i !== n && (t[n] = s, delete t[i]), (r = dt.cssHooks[n]) && "expand" in r) {
            s = r.expand(s),
            delete t[n];
    ...
    function H(t, e, i) {
        ...
        l = function() {
            if (o) return ! 1;
            for (var e = Te || R(), i = Math.max(0, u.startTime + u.duration - e), n = 1 - (i / u.duration || 0), s = 0, r = u.tweens.length; r > s; s++) u.tweens[s].run(n);
            return a.notifyWith(t, [u, n, i]),
            1 > n && r ? i: (a.resolveWith(t, [u]), !1)
        },
        u = a.promise({
            elem: t,
            props: dt.extend({},
        ...
        c = u.props;
        for (W(c, u.opts.specialEasing); r > s; s++) if (n = H.prefilters[s].call(u, t, c, u.opts)) return dt.isFunction(n.stop) && (dt._queueHooks(u.elem, u.opts.queue).stop = dt.proxy(n.stop, n)),
        n;
        return dt.map(c, j, u),
    ...
    function U(t) {
        return function(e, i) {
            ...
            if (dt.isFunction(i)) for (; n = s[o++];)"+" === n.charAt(0) ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
        }
    }
    function B(t, e, i, n) {
        function o(a) {
    ...
    function Q(t, e, i, n) {
        ...
        for (s = c.shift(); s;) if (t.responseFields[s] && (i[t.responseFields[s]] = e), !l && n && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = s, s = c.shift()) if ("*" === s) s = l;
            ...
            if (! (r = u[l + " " + s] || u["* " + s])) for (o in u) if ((a = o.split(" "))[1] === s && (r = u[l + " " + a[0]] || u["* " + a[0]])) { ! 0 === r ? r = u[o] : !0 !== u[o] && (s = a[0], c.unshift(a[1]));
                break
            }
    ...
    dt.extend = dt.fn.extend = function() {
        ...
        l = arguments.length,
        u = !1;
        for ("boolean" == typeof r && (u = r, r = arguments[a] || {},
        a++), "object" == typeof r || dt.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++) if (null != (o = arguments[a])) for (n in o) t = r[n],
        i = o[n],
        r !== i && (u && i && (dt.isPlainObject(i) || (e = dt.isArray(i))) ? (e ? (e = !1, s = t && dt.isArray(t) ? t: []) : s = t && dt.isPlainObject(t) ? t: {},
        r[n] = dt.extend(u, s, i)) : void 0 !== i && (r[n] = i));
        return r
    },
    dt.extend({
        ...
        each: function(t, e) {
            var n, o = 0;
            if (i(t)) for (n = t.length; n > o && !1 !== e.call(t[o], o, t[o]); o++);
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (i(Object(t)) ? dt.merge(n, "string" == typeof t ? [t] : t) : st.call(n, t)),
            n
        },
        ...
        map: function(t, e, n) {
            var o, s, r = 0,
            a = [];
            if (i(t)) for (o = t.length; o > r; r++) null != (s = e(t[r], r, n)) && a.push(s);
        ...
        proxy: function(t, e) {
            ...
            dt.isFunction(t) ? (i = nt.call(arguments, 2), n = function() {
    ...
    var vt = function(t) {
        function e(t, e, i, n) {
            var o, s, r, a, u, h, d, p, f = e && e.ownerDocument,
            m = e ? e.nodeType: 9;
            if (i = i || [], "string" != typeof t || !t || 1 !== m && 9 !== m && 11 !== m) return i;
            if (!n && ((e ? e.ownerDocument || e: R) !== A && I(e), e = e || A, M)) {
                if (11 !== m && (h = mt.exec(t))) if (o = h[1]) {
                    if (9 === m) {
                        if (! (r = e.getElementById(o))) return i;
                        if (r.id === o) return i.push(r),
                        i
                    } else if (f && (r = f.getElementById(o)) && z(e, r) && r.id === o) return i.push(r),
                    i
                } else {
                    if (h[2]) return Z.apply(i, e.getElementsByTagName(t)),
                    i;
                    if ((o = h[3]) && w.getElementsByClassName && e.getElementsByClassName) return Z.apply(i, e.getElementsByClassName(o)),
                    i
                }
                if (w.qsa && !q[t + " "] && (!N || !N.test(t))) {
                    ...
                    p = t;
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = P), s = (d = C(t)).length, u = ct.test(a) ? "#" + a: "[id='" + a + "']"; s--;) d[s] = u + " " + c(d[s]);
                        p = d.join(","),
                        f = gt.test(t) && l(e.parentNode) || e
                    }
                    if (p) try {
                        return Z.apply(i, f.querySelectorAll(p)),
                        i
                    } catch(t) {} finally {
        ...
        function h(t, e, i) {
            ...
            function(e, i, s) {
                ...
                if (r) {
                    ...
                    if (u = e[P] || (e[P] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (a = l[n]) && a[0] === F && a[1] === s) return c[2] = a[2];
        ...
        function m(t, e, i, o, s, r) {
            ...
            n(function(n, r, a, l) {
                ...
                w = i ? s || (n ? t: g || o) ? [] : r: y;
                if (i && i(y, w, a, l), o) for (u = f(w, m), o(u, [], a, l), c = u.length; c--;)(h = u[c]) && (w[m[c]] = !(y[m[c]] = h));
                if (n) {
                    if (s || t) {
                        if (s) {
                        ...
                        for (c = w.length; c--;)(h = w[c]) && (u = s ? K(n, h) : d[c]) > -1 && (n[u] = !(r[u] = h))
                    }
                } else w = f(w === r ? w.splice(g, w.length) : w),
                s ? s(null, r, w, l) : Z.apply(r, w)
            })
        }
        function g(t) {
            for (var e, i, n, o = t.length,
            s = b.relative[t[0].type], r = s || b.relative[" "], a = s ? 1 : 0, l = h(function(t) {
                return t === e
            },
            r, !0), u = h(function(t) {
                return K(e, t) > -1
            ...
            r, !0), p = [function(t, i, n) {
                ...
                return e = null,
                o
            }]; o > a; a++) if (i = b.relative[t[a].type]) p = [h(d(p), i)];
            else {
                if ((i = b.filter[t[a].type].apply(null, t[a].matches))[P]) {
                    for (n = ++a; o > n && !b.relative[t[n].type]; n++);
                    return m(a > 1 && d(p), a > 1 && c(t.slice(0, a - 1).concat({
                        value: " " === t[a - 2].type ? "*": ""
                    })).replace(st, "$1"), i, n > a && g(t.slice(a, n)), o > n && g(t = t.slice(n)), o > n && c(t))
                }
                p.push(i)
            }
            return d(p)
        ...
        function v(t, i) {
            ...
            r = function(n, r, a, l, u) {
                ...
                T = w.length;
                for (u && (S = r === A || r || u); m !== T && null != (c = w[m]); m++) {
                    if (s && c) {
                        for (h = 0, r || c.ownerDocument === A || (I(c), a = !M); d = t[h++];) if (d(c, r || A, a)) {
                            l.push(c);
                            break
                        }
                        u && (F = x)
                ...
                if (p += m, o && m !== p) {
                    ...
                    if (n) {
                        if (p > 0) for (; m--;) g[m] || v[m] || (v[m] = Q.call(l));
                        v = f(v)
                    }
                    Z.apply(l, v),
                    u && !n && v.length > 0 && p + i.length > 1 && e.uniqueSort(l)
                }
                return u && (F = x, S = y),
                g
            };
        ...
        var y, w, b, x, T, C, _, k, S, D, E, I, A, O, M, N, L, $, z, P = "sizzle" + 1 * new Date,
        R = t.document,
        F = 0,
        j = 0,
        W = i(),
        ...
        try {
            Z.apply(V = G.call(R.childNodes), R.childNodes),
        ...
        I = e.setDocument = function(t) {
            ...
            return n !== A && 9 === n.nodeType && n.documentElement ? (A = n, O = A.documentElement, M = !T(A), (i = A.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)), w.attributes = o(function(t) {
            ...
            L = [], N = [], (w.qsa = ft.test(A.querySelectorAll)) && (o(function(t) {
                ...
                t.querySelectorAll("[id~=" + P + "-]").length || N.push("~="),
                t.querySelectorAll(":checked").length || N.push(":checked"),
                t.querySelectorAll("a#" + P + "+*").length || N.push(".#.+[+~]")
            }), o(function(t) {
                ...
                N.push(",.*:")
            })), (w.matchesSelector = ft.test($ = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function(t) {
                w.disconnectedMatch = $.call(t, "div"),
                $.call(t, "[s!='']:x"),
                L.push("!=", nt)
            }), N = N.length && new RegExp(N.join("|")), L = L.length && new RegExp(L.join("|")), e = ft.test(O.compareDocumentPosition), z = e || ft.test(O.contains) ?
            function(t, e) {
            ...
            function(t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === A || t.ownerDocument === R && z(R, t) ? -1 : e === A || e.ownerDocument === R && z(R, e) ? 1 : D ? K(D, t) - K(D, e) : 0 : 4 & i ? -1 : 1)
            }: function(t, e) {
                if (t === e) return E = !0,
                0;
                var i, n = 0,
                ...
                a = [t],
                l = [e];
                if (!o || !s) return t === A ? -1 : e === A ? 1 : o ? -1 : s ? 1 : D ? K(D, t) - K(D, e) : 0;
                if (o === s) return r(t, e);
        ...
        e.matchesSelector = function(t, i) {
            if ((t.ownerDocument || t) !== A && I(t), i = i.replace(lt, "='$1']"), w.matchesSelector && M && !q[i + " "] && (!L || !L.test(i)) && (!N || !N.test(i))) try {
                var n = $.call(t, i);
        ...
        e.attr = function(t, e) { (t.ownerDocument || t) !== A && I(t);
            var i = b.attrHandle[e.toLowerCase()],
            n = i && Y.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !M) : void 0;
        ...
        e.uniqueSort = function(t) {
            ...
            n = 0,
            o = 0;
            if (E = !w.detectDuplicates, D = !w.sortStable && t.slice(0), t.sort(U), E) {
        ...
        (b = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return ht.CHILD.test(t[0]) ? null: (t[3] ? t[2] = t[4] || t[5] || "": i && ut.test(i) && (e = C(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function(t) {
                ...
                CLASS: function(t) {
                    var e = W[t + " "];
                    return e || (e = new RegExp("(^|" + tt + ")" + t + "(" + tt + "|$)")) && W(t,
                    function(t) {
                ...
                CHILD: function(t, e, i, n, o) {
                    ...
                    function(t) {
                        ...
                        var u, c, h, d, p, f, m = s !== r ? "nextSibling": "previousSibling",
                        g = e.parentNode,
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild: g.lastChild], r && y) {
                                for (w = (p = (u = (c = (h = (d = g)[P] || (d[P] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === F && u[1]) && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (w = p = 0) || f.pop();) if (1 === d.nodeType && ++w && d === e) {
                                    c[t] = [F, p, w];
                                    break
                                }
                            } else if (y && (d = e, h = d[P] || (d[P] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], p = u[0] === F && u[1], w = p), !1 === w) for (; (d = ++p && d && d[m] || (w = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++w || (y && (h = d[P] || (d[P] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [F, w]), d !== e)););
                ...
                PSEUDO: function(t, i) {
                    ...
                    return s[P] ? s(i) : s.length > 1 ? (o = [t, t, "", i], b.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function(t, e) {
                        for (var n, o = s(t, i), r = o.length; r--;) n = K(t, o[r]),
                        t[n] = !(e[n] = o[r])
                    }) : function(t) {
                        return s(t, 0, o)
                    }) : s
        ...
        C = e.tokenize = function(t, i) {
            var n, o, s, r, a, l, u, c = H[t + " "];
            if (c) return i ? 0 : c.slice(0);
            for (a = t, l = [], u = b.preFilter; a;) {
                n && !(o = rt.exec(a)) || (o && (a = a.slice(o[0].length) || a), l.push(s = [])),
                n = !1,
                (o = at.exec(a)) && (n = o.shift(), s.push({
                    value: n,
                    type: o[0].replace(st, " ")
                }), a = a.slice(n.length));
                for (r in b.filter) ! (o = ht[r].exec(a)) || u[r] && !(o = u[r](o)) || (n = o.shift(), s.push({
                    value: n,
                    type: r,
                    matches: o
                }), a = a.slice(n.length));
        ...
        _ = e.compile = function(t, e) {
            ...
            s = q[t + " "];
            if (!s) {
                for (e || (e = C(t)), i = e.length; i--;)(s = g(e[i]))[P] ? n.push(s) : o.push(s); (s = q(t, v(o, n))).selector = t
            }
            return s
        },
        k = e.select = function(t, e, i, n) {
            var o, s, r, a, u, h = "function" == typeof t && t,
            d = !n && C(t = h.selector || t);
            if (i = i || [], 1 === d.length) {
                if ((s = d[0] = d[0].slice(0)).length > 2 && "ID" === (r = s[0]).type && w.getById && 9 === e.nodeType && M && b.relative[s[1].type]) {
                    if (! (e = (b.find.ID(r.matches[0].replace(yt, wt), e) || [])[0])) return i;
                    h && (e = e.parentNode),
                    t = t.slice(s.shift().value.length)
                }
                for (o = ht.needsContext.test(t) ? 0 : s.length; o--&&(r = s[o], !b.relative[a = r.type]);) if ((u = b.find[a]) && (n = u(r.matches[0].replace(yt, wt), gt.test(s[0].type) && l(e.parentNode) || e))) {
                    if (s.splice(o, 1), !(t = n.length && c(s))) return Z.apply(i, n),
                    i;
                    break
                }
            }
            return (h || _(t, d))(n, e, !M, i, !e || gt.test(t) && l(e.parentNode) || e),
            i
        },
    ...
    dt.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? dt.find.matchesSelector(n, t) ? [n] : [] : dt.find.matches(t, dt.grep(e,
        function(t) {
            return 1 === t.nodeType
        }))
    },
    dt.fn.extend({
        find: function(t) {
            ...
            return i = this.pushStack(o > 1 ? dt.unique(i) : i),
        ...
        is: function(t) {
            return !! n(this, "string" == typeof t && bt.test(t) ? dt(t) : t || [], !1).length
        }
    });
    var Ct, _t = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/; (dt.fn.init = function(t, e, i) {
        var n, o;
        if (!t) return this;
        if (i = i || Ct, "string" == typeof t) {
            ...
            if (n[1]) {
                if (e = e instanceof dt ? e[0] : e, dt.merge(this, dt.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e: it, !0)), xt.test(n[1]) && dt.isPlainObject(e)) for (n in e) dt.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
        ...
        return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : dt.isFunction(t) ? void 0 !== i.ready ? i.ready(t) : t(dt) : (void 0 !== t.selector && (this.selector = t.selector, this.context = t.context), dt.makeArray(t, this))
    }).prototype = dt.fn,
    Ct = dt(it);
    ...
    dt.fn.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0,
            o = this.length,
            s = [], r = bt.test(t) || "string" != typeof t ? dt(t, e || this.context) : 0; o > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && dt.find.matchesSelector(i, t))) {
                s.push(i);
                break
            }
    ...
    function(t, e) {
        dt.fn[t] = function(i, n) {
            ...
            n && "string" == typeof n && (o = dt.filter(n, o)),
            this.length > 1 && (St[t] || (o = dt.uniqueSort(o)), kt.test(t) && (o = o.reverse())),
            this.pushStack(o)
        }
    });
    var Dt = /\S+/g;
    dt.Callbacks = function(t) {
        t = "string" == typeof t ? s(t) : dt.extend({},
        t);
        var e, i, n, o, r = [],
        a = [],
        l = -1,
        u = function() {
            for (o = t.once, n = e = !0; a.length; l = -1) for (i = a.shift(); ++l < r.length;) ! 1 === r[l].apply(i[0], i[1]) && t.stopOnFalse && (l = r.length, i = !1);
            t.memory || (i = !1),
            e = !1,
            o && (r = i ? [] : "")
        },
        c = {
            add: function() {
                return r && (i && !e && (l = r.length - 1, a.push(i)),
                function e(i) {
                    dt.each(i,
                    function(i, n) {
            ...
            remove: function() {
                ...
                function(t, e) {
                    for (var i; (i = dt.inArray(e, r, i)) > -1;) r.splice(i, 1),
                    l >= i && l--
                }),
                this
            },
    ...
    dt.extend({
                    ...
                    return dt.Deferred(function(i) {
                        ...
                        function(e, s) {
                            ...
                            o[s[1]](function() {
                                ...
                                t && dt.isFunction(t.promise) ? t.promise().progress(i.notify).done(i.resolve).fail(i.reject) : i[s[0] + "With"](this === n ? i.promise() : this, r ? [t] : arguments)
                            })
                        }),
                        t = null
                    }).promise()
        ...
        when: function(t) {
            ...
            u = function(t, i, n) {
                return function(o) {
                    i[t] = this,
                    n[t] = arguments.length > 1 ? nt.call(arguments) : o,
                    n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n)
                }
            };
            if (r > 1) for (e = new Array(r), i = new Array(r), n = new Array(r); r > o; o++) s[o] && dt.isFunction(s[o].promise) ? s[o].promise().progress(u(o, i, e)).done(u(o, n, s)).fail(l.reject) : --a;
    ...
    dt.extend({
        ...
        ready: function(t) { (!0 === t ? --dt.readyWait: dt.isReady) || (dt.isReady = !0, !0 !== t && --dt.readyWait > 0 || (Et.resolveWith(it, [dt]), dt.fn.triggerHandler && (dt(it).triggerHandler("ready"), dt(it).off("ready"))))
        }
    }),
    dt.ready.promise = function(e) {
        if (!Et) if (Et = dt.Deferred(), "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll) t.setTimeout(dt.ready);
        else if (it.addEventListener) it.addEventListener("DOMContentLoaded", a),
    ...
    dt.extend({
        ...
        hasData: function(t) {
            return !! (t = t.nodeType ? dt.cache[t[dt.expando]] : t[dt.expando]) && !u(t)
        },
        data: function(t, e, i) {
            return c(t, e, i)
        },
    ...
    dt.fn.extend({
        data: function(t, e) {
            ...
            r = s && s.attributes;
            if (void 0 === t) {
                if (this.length && (o = dt.data(s), 1 === s.nodeType && !dt._data(s, "parsedAttrs"))) {
                    for (i = r.length; i--;) r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = dt.camelCase(n.slice(5)), l(s, n, o[n]));
    ...
    dt.extend({
        queue: function(t, e, i) {
            var n;
            return t ? (e = (e || "fx") + "queue", n = dt._data(t, e), i && (!n || dt.isArray(i) ? n = dt._data(t, e, dt.makeArray(i)) : n.push(i)), n || []) : void 0
        },
        dequeue: function(t, e) {
            ...
            o && ("fx" === e && i.unshift("inprogress"), delete s.stop, o.call(t,
            function() {
                dt.dequeue(t, e)
            },
            s)),
    ...
    dt.fn.extend({
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;)(i = dt._data(s[r], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
            return a(),
            o.promise(e)
        }
    }),
    ...
    Pt = function(t, e, i, n, o, s, r) {
        var a = 0,
        l = t.length,
        u = null == i;
        if ("object" === dt.type(i)) {
            o = !0;
            for (a in i) Pt(t, e, a, i[a], !0, s, r)
        } else if (void 0 !== n && (o = !0, dt.isFunction(n) || (r = !0), u && (r ? (e.call(t, n), e = null) : (u = e, e = function(t, e, i) {
    ...
    function() {
        ...
        ct.leadingWhitespace = 3 === t.firstChild.nodeType,
        ct.tbody = !t.getElementsByTagName("tbody").length,
        ct.htmlSerialize = !!t.getElementsByTagName("link").length,
        ct.html5Clone = "<:nav></:nav>" !== it.createElement("nav").cloneNode(!0).outerHTML,
        i.type = "checkbox",
        i.checked = !0,
        e.appendChild(i),
        ct.appendChecked = i.checked,
        t.innerHTML = "<textarea>x</textarea>",
        ct.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue,
        e.appendChild(t),
        (i = it.createElement("input")).setAttribute("type", "radio"),
        i.setAttribute("checked", "checked"),
        i.setAttribute("name", "t"),
        t.appendChild(i),
        ct.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked,
        ct.noCloneEvent = !!t.addEventListener,
        t[dt.expando] = 1,
        ct.attributes = !t.getAttribute(dt.expando)
    } ();
    var qt = {
    ...
    dt.event = {
        ...
        add: function(t, e, i, n, o) {
            var s, r, a, l, u, c, h, d, p, f, m, g = dt._data(t);
            if (g) {
                for (i.handler && (l = i, i = l.handler, o = l.selector), i.guid || (i.guid = dt.guid++), (r = g.events) || (r = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                    return void 0 === dt || t && dt.event.triggered === t.type ? void 0 : dt.event.dispatch.apply(c.elem, arguments)
                },
                c.elem = t), a = (e = (e || "").match(Dt) || [""]).length; a--;) s = Zt.exec(e[a]) || [],
                p = m = s[1],
                f = (s[2] || "").split(".").sort(),
                p && (u = dt.event.special[p] || {},
                p = (o ? u.delegateType: u.bindType) || p, u = dt.event.special[p] || {},
                h = dt.extend({
                    type: p,
                    origType: m,
                    data: n,
                ...
                l), (d = r[p]) || (d = r[p] = [], d.delegateCount = 0, u.setup && !1 !== u.setup.call(t, n, f, c) || (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent("on" + p, c))), u.add && (u.add.call(t, h), h.handler.guid || (h.handler.guid = i.guid)), o ? d.splice(d.delegateCount++, 0, h) : d.push(h), dt.event.global[p] = !0);
                t = null
            }
        },
        remove: function(t, e, i, n, o) {
            var s, r, a, l, u, c, h, d, p, f, m, g = dt.hasData(t) && dt._data(t);
            if (g && (c = g.events)) {
                for (u = (e = (e || "").match(Dt) || [""]).length; u--;) if (a = Zt.exec(e[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                    for (h = dt.event.special[p] || {},
                    d = c[p = (n ? h.delegateType: h.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = d.length; s--;) r = d[s],
                    !o && m !== r.origType || i && i.guid !== r.guid || a && !a.test(r.namespace) || n && n !== r.selector && ("**" !== n || !r.selector) || (d.splice(s, 1), r.selector && d.delegateCount--, h.remove && h.remove.call(t, r));
                    l && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, g.handle) || dt.removeEvent(t, p, g.handle), delete c[p])
                } else for (p in c) dt.event.remove(t, p + e[u], i, n, !0);
                dt.isEmptyObject(c) && (delete g.handle, dt._removeData(t, "events"))
            }
        },
        trigger: function(e, i, n, o) {
            var s, r, a, l, u, c, h, d = [n || it],
            p = ut.call(e, "type") ? e.type: e,
            f = ut.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = c = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !Xt.test(p + dt.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), r = p.indexOf(":") < 0 && "on" + p, e = e[dt.expando] ? e: new dt.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : dt.makeArray(i, [e]), u = dt.event.special[p] || {},
            o || !u.trigger || !1 !== u.trigger.apply(n, i))) {
                if (!o && !u.noBubble && !dt.isWindow(n)) {
                    for (l = u.delegateType || p, Xt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a),
                    c = a;
                    c === (n.ownerDocument || it) && d.push(c.defaultView || c.parentWindow || t)
                }
                for (h = 0; (a = d[h++]) && !e.isPropagationStopped();) e.type = h > 1 ? l: u.bindType || p,
                (s = (dt._data(a, "events") || {})[e.type] && dt._data(a, "handle")) && s.apply(a, i),
                (s = r && a[r]) && s.apply && At(a) && (e.result = s.apply(a, i), !1 === e.result && e.preventDefault());
                if (e.type = p, !o && !e.isDefaultPrevented() && (!u._default || !1 === u._default.apply(d.pop(), i)) && At(n) && r && n[p] && !dt.isWindow(n)) { (c = n[r]) && (n[r] = null),
        ...
        handlers: function(t, e) {
            ...
            if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
                for (n = [], i = 0; a > i; i++) s = e[i],
                o = s.selector + " ",
                void 0 === n[o] && (n[o] = s.needsContext ? dt(o, this).index(l) > -1 : dt.find(o, this, null, [l]).length),
                n[o] && n.push(s);
                n.length && r.push({
                    elem: l,
                    handlers: n
        ...
        fix: function(t) {
            ...
            s = t,
            r = this.fixHooks[o];
            for (r || (this.fixHooks[o] = r = Qt.test(o) ? this.mouseHooks: Vt.test(o) ? this.keyHooks: {}), n = r.props ? this.props.concat(r.props) : this.props, t = new dt.Event(s), e = n.length; e--;) i = n[e],
            t[i] = s[i];
            return t.target || (t.target = s.srcElement || it),
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                r = e.fromElement;
                return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || it, o = n.documentElement, i = n.body, t.pageX = e.clientX + (o && o.scrollLeft || i && i.scrollLeft || 0) - (o && o.clientLeft || i && i.clientLeft || 0), t.pageY = e.clientY + (o && o.scrollTop || i && i.scrollTop || 0) - (o && o.clientTop || i && i.clientTop || 0)),
    ...
    dt.Event = function(t, e) {
        return this instanceof dt.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? y: w) : this.type = t, e && dt.extend(this, e), this.timeStamp = t && t.timeStamp || dt.now(), void(this[dt.expando] = !0)) : new dt.Event(t, e)
    },
    dt.Event.prototype = {
    ...
    function(t, e) {
        dt.event.special[t] = {
            ...
            handle: function(t) {
                ...
                o = t.relatedTarget,
                s = t.handleObj;
                return o && (o === n || dt.contains(n, o)) || (t.type = s.origType, i = s.handler.apply(this, arguments), t.type = e),
                i
            }
        }
    }),
    ct.submit || (dt.event.special.submit = {
        setup: function() {
            return ! dt.nodeName(this, "form") && void dt.event.add(this, "click._submit keypress._submit",
            function(t) {
                var e = t.target,
                i = dt.nodeName(e, "input") || dt.nodeName(e, "button") ? dt.prop(e, "form") : void 0;
                i && !dt._data(i, "submit") && (dt.event.add(i, "submit._submit",
                function(t) {
                    t._submitBubble = !0
                }), dt._data(i, "submit", !0))
            })
    ...
    ct.change || (dt.event.special.change = {
        setup: function() {
            return Yt.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (dt.event.add(this, "propertychange._change",
            function(t) {
            ...
            })), !1) : void dt.event.add(this, "beforeactivate._change",
            function(t) {
                var e = t.target;
                Yt.test(e.nodeName) && !dt._data(e, "change") && (dt.event.add(e, "change._change",
    ...
    function(t, e) {
        ...
        dt.event.special[e] = {
            ...
            teardown: function() {
                var n = this.ownerDocument || this,
                o = dt._data(n, e) - 1;
                o ? dt._data(n, e, o) : (n.removeEventListener(t, i, !0), dt._removeData(n, e))
            }
        }
    }),
    dt.fn.extend({
    ...
    dt.extend({
        ...
        clone: function(t, e, i) {
            var n, o, s, r, a, l = dt.contains(t.ownerDocument, t);
            if (ct.html5Clone || dt.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML, oe.removeChild(s = oe.firstChild)), !(ct.noCloneEvent && ct.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || dt.isXMLDoc(t))) for (n = f(s), a = f(t), r = 0; null != (o = a[r]); ++r) n[r] && S(o, n[r]);
            if (e) if (i) for (a = a || f(t), n = n || f(s), r = 0; null != (o = a[r]); r++) k(o, n[r]);
            else k(t, s);
            return (n = f(s, "script")).length > 0 && m(n, !l && f(t, "script")),
            n = a = o = null,
            s
        },
        cleanData: function(t, e) {
            ...
            l = dt.cache,
            u = ct.attributes,
            c = dt.event.special; null != (i = t[r]); r++) if ((e || At(i)) && (o = i[a], s = o && l[o])) {
                if (s.events) for (n in s.events) c[n] ? dt.event.remove(i, n) : dt.removeEvent(i, n, s.handle);
    ...
    dt.fn.extend({
        ...
        html: function(t) {
            ...
            function(t) {
                ...
                if ("string" == typeof t && !te.test(t) && (ct.htmlSerialize || !Kt.test(t)) && (ct.leadingWhitespace || !Wt.test(t)) && !qt[(Ft.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = dt.htmlPrefilter(t);
                    try {
                        for (; n > i; i++) 1 === (e = this[i] || {}).nodeType && (dt.cleanData(f(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch(t) {}
                }
    ...
    function(t, e) {
        dt.fn[t] = function(t) {
            for (var i, n = 0,
            o = [], s = dt(t), r = s.length - 1; r >= n; n++) i = n === r ? this: this.clone(!0),
            dt(s[n])[e](i),
            st.apply(o, i.get());
    ...
    var he, de, pe = /^(top|right|bottom|left)$/;
    ...
    de = function(t, e, i) {
        ...
        return i = i || he(t),
        "" !== (r = i ? i.getPropertyValue(e) || i[e] : void 0) && void 0 !== r || dt.contains(t.ownerDocument, t) || (r = dt.style(t, e)),
        i && !ct.pixelMarginRight() && le.test(r) && ae.test(e) && (n = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = n, a.minWidth = o, a.maxWidth = s),
        void 0 === r ? r: r + ""
    }) : ce.currentStyle && (he = function(t) {
        return t.currentStyle
    },
    de = function(t, e, i) {
        var n, o, s, r, a = t.style;
        return i = i || he(t),
        null == (r = i ? i[e] : void 0) && a && a[e] && (r = a[e]),
        le.test(r) && !pe.test(e) && (n = a.left, o = t.runtimeStyle, (s = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em": r, r = a.pixelLeft + "px", a.left = n, s && (o.left = s)),
        void 0 === r ? r: r + "" || "auto"
    });
    var fe = /alpha\([^)]*\)/i,
    me = /opacity\s*=\s*([^)]*)/i,
    ...
    dt.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                l = t.style;
                if (e = dt.cssProps[a] || (dt.cssProps[a] = M(a) || a), r = dt.cssHooks[e] || dt.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (o = r.get(t, !1, n)) ? o: l[e];
                if ("string" === (s = typeof i) && (o = Lt.exec(i)) && o[1] && (i = d(t, e, o), s = "number"), null != i && i === i && ("number" === s && (i += o && o[3] || (dt.cssNumber[a] ? "": "px")), ct.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(r && "set" in r && void 0 === (i = r.set(t, i, n))))) try {
                    l[e] = i
                } catch(t) {}
            }
        },
        css: function(t, e, i, n) {
            var o, s, r, a = dt.camelCase(e);
            return e = dt.cssProps[a] || (dt.cssProps[a] = M(a) || a),
            (r = dt.cssHooks[e] || dt.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)),
            void 0 === s && (s = de(t, e, n)),
            "normal" === s && e in we && (s = we[e]),
    ...
    function(t, e) {
        dt.cssHooks[e] = {
            get: function(t, i, n) {
                return i ? ge.test(dt.css(t, "display")) && 0 === t.offsetWidth ? ue(t, ye,
                function() {
                    return z(t, e, n)
                }) : z(t, e, n) : void 0
            },
            set: function(t, i, n) {
                var o = n && he(t);
                return L(0, i, n ? $(t, e, n, ct.boxSizing && "border-box" === dt.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
    }),
    ct.opacity || (dt.cssHooks.opacity = {
        ...
        set: function(t, e) {
            ...
            i.zoom = 1,
            (e >= 1 || "" === e) && "" === dt.trim(s.replace(fe, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === e || n && !n.filter) || (i.filter = fe.test(s) ? s.replace(fe, o) : s + " " + o)
        }
    }),
    dt.cssHooks.marginRight = O(ct.reliableMarginRight,
    function(t, e) {
        return e ? ue(t, {
    ...
    dt.cssHooks.marginLeft = O(ct.reliableMarginLeft,
    function(t, e) {
        return e ? (parseFloat(de(t, "marginLeft")) || (dt.contains(t.ownerDocument, t) ? t.getBoundingClientRect().left - ue(t, {
            marginLeft: 0
        },
        function() {
    ...
    function(t, e) {
        dt.cssHooks[t + e] = {
            expand: function(i) {
                for (var n = 0,
                o = {},
                s = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) o[t + $t[n] + e] = s[n] || s[n - 2] || s[0];
                return o
            }
        },
        ae.test(t) || (dt.cssHooks[t + e].set = L)
    }),
    dt.fn.extend({
        css: function(t, e) {
            return Pt(this,
            function(t, e, i) {
                ...
                r = 0;
                if (dt.isArray(e)) {
                    for (n = he(t), o = e.length; o > r; r++) s[e[r]] = dt.css(t, e[r], !1, n);
                    return s
                }
    ...
    dt.fx = P.prototype.init,
    dt.fx.step = {};
    var Te, Ce, _e = /^(?:toggle|show|hide)$/,
    ke = /queueHooks$/;
    dt.Animation = dt.extend(H, {
        tweeners: {
            "*": [function(t, e) {
                var i = this.createTween(t, e);
                return d(i.elem, t, Lt.exec(e), i),
                i
            }]
        },
        tweener: function(t, e) {
            ...
            for (var i, n = 0,
            o = t.length; o > n; n++) i = t[n],
            H.tweeners[i] = H.tweeners[i] || [],
            H.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, o, s, r, a, l, u, c = this,
            h = {},
            d = t.style,
            p = t.nodeType && zt(t),
            f = dt._data(t, "fxshow");
            i.queue || (null == (a = dt._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function() {
                a.unqueued || l()
            }), a.unqueued++, c.always(function() {
                c.always(function() {
                    a.unqueued--,
                    dt.queue(t, "fx").length || a.empty.fire()
                })
            })),
            1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === ("none" === (u = dt.css(t, "display")) ? dt._data(t, "olddisplay") || A(t.nodeName) : u) && "none" === dt.css(t, "float") && (ct.inlineBlockNeedsLayout && "inline" !== A(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")),
            i.overflow && (d.overflow = "hidden", ct.shrinkWrapBlocks() || c.always(function() {
            ...
            for (n in e) if (o = e[n], _e.exec(o)) {
                ...
                h[n] = f && f[n] || dt.style(t, n)
            } else u = void 0;
            if (dt.isEmptyObject(h))"inline" === ("none" === u ? A(t.nodeName) : u) && (d.display = u);
            else {
                f ? "hidden" in f && (p = f.hidden) : f = dt._data(t, "fxshow", {}),
                s && (f.hidden = !p),
    ...
    dt.speed = function(t, e, i) {
        var n = t && "object" == typeof t ? dt.extend({},
        t) : {
    ...
    dt.fn.extend({
        ...
        animate: function(t, e, i, n) {
            ...
            s = dt.speed(e, i, n),
            r = function() {
                var e = H(this, dt.extend({},
                t), s); (o || dt._data(this, "finish")) && e.stop(!0)
            };
            return r.finish = r,
        ...
        stop: function(t, e, i) {
            ...
            this.each(function() {
                ...
                else for (o in r) r[o] && r[o].stop && ke.test(o) && n(r[o]);
                for (o = s.length; o--;) s[o].elem !== this || null != t && s[o].queue !== t || (s[o].anim.stop(i), e = !1, s.splice(o, 1)); ! e && i || dt.dequeue(this, t)
            })
        },
        finish: function(t) {
            return ! 1 !== t && (t = t || "fx"),
            this.each(function() {
                ...
                s = dt.timers,
                r = n ? n.length: 0;
                for (i.finish = !0, dt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = s.length; e--;) s[e].elem === this && s[e].queue === t && (s[e].anim.stop(!0), s.splice(e, 1));
    ...
    dt.fx.tick = function() {
        var t, e = dt.timers,
        i = 0;
        for (Te = dt.now(); i < e.length; i++)(t = e[i])() || e[i] !== t || e.splice(i--, 1);
        e.length || dt.fx.stop(),
        Te = void 0
    },
    ...
    function() {
        ...
        o = n.appendChild(it.createElement("option")); (i = it.createElement("div")).setAttribute("className", "t"),
        ...
        ct.checkOn = !!e.value,
        ct.optSelected = o.selected,
        ct.enctype = !!it.createElement("form").enctype,
        n.disabled = !0,
        ct.optDisabled = !o.disabled,
    ...
    dt.fn.extend({
        val: function(t) {
            ...
            return arguments.length ? (n = dt.isFunction(t), this.each(function(i) {
                var o;
                1 === this.nodeType && (null == (o = n ? t.call(this, i, dt(this).val()) : t) ? o = "": "number" == typeof o ? o += "": dt.isArray(o) && (o = dt.map(o,
                function(t) {
                    return null == t ? "": t + ""
                })), (e = dt.valHooks[this.type] || dt.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, o, "value") || (this.value = o))
            })) : o ? (e = dt.valHooks[o.type] || dt.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (i = e.get(o, "value")) ? i: "string" == typeof(i = o.value) ? i.replace(Se, "") : null == i ? "": i: void 0
        }
    }),
    dt.extend({
        valHooks: {
            option: {
                get: function(t) {
                    ...
                    return null != e ? e: dt.trim(dt.text(t)).replace(De, " ")
                }
            },
            select: {
                get: function(t) {
                    ...
                    r = s ? null: [], a = s ? o + 1 : n.length, l = 0 > o ? a: s ? o: 0; a > l; l++) if (((i = n[l]).selected || l === o) && (ct.optDisabled ? !i.disabled: null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !dt.nodeName(i.parentNode, "optgroup"))) {
                        if (e = dt(i).val(), s) return e;
                        r.push(e)
                    }
                    return r
                },
                set: function(t, e) {
                    for (var i, n, o = t.options,
                    s = dt.makeArray(e), r = o.length; r--;) if (n = o[r], dt.inArray(dt.valHooks.option.get(n), s) > -1) try {
                        n.selected = i = !0
                    } catch(t) {
                        n.scrollHeight
                    } else n.selected = !1;
    ...
    var Ee, Ie, Ae = dt.expr.attrHandle,
    Oe = /^(?:checked|selected)$/i,
    Me = ct.getSetAttribute,
    Ne = ct.input;
    dt.fn.extend({
        attr: function(t, e) {
            return Pt(this, dt.attr, t, e, arguments.length > 1)
        },
    ...
    dt.extend({
        attr: function(t, e, i) {
            var n, o, s = t.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return void 0 === t.getAttribute ? dt.prop(t, e, i) : (1 === s && dt.isXMLDoc(t) || (e = e.toLowerCase(), o = dt.attrHooks[e] || (dt.expr.match.bool.test(e) ? Ie: Ee)), void 0 !== i ? null === i ? void dt.removeAttr(t, e) : o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n: (t.setAttribute(e, i + ""), i) : o && "get" in o && null !== (n = o.get(t, e)) ? n: null == (n = dt.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        removeAttr: function(t, e) {
            var i, n, o = 0,
            s = e && e.match(Dt);
            if (s && 1 === t.nodeType) for (; i = s[o++];) n = dt.propFix[i] || i,
            dt.expr.match.bool.test(i) ? Ne && Me || !Oe.test(i) ? t[n] = !1 : t[dt.camelCase("default-" + i)] = t[n] = !1 : dt.attr(t, i, ""),
            t.removeAttribute(Me ? i: n)
        }
    }),
    Ie = {
        set: function(t, e, i) {
            return ! 1 === e ? dt.removeAttr(t, i) : Ne && Me || !Oe.test(i) ? t.setAttribute(!Me && dt.propFix[i] || i, i) : t[dt.camelCase("default-" + i)] = t[i] = !0,
            i
        }
    },
    ...
    function(t, e) {
        ...
        Ne && Me || !Oe.test(e) ? Ae[e] = function(t, e, n) {
            var o, s;
            return n || (s = Ae[e], Ae[e] = o, o = null != i(t, e, n) ? e.toLowerCase() : null, Ae[e] = s),
            o
        }: Ae[e] = function(t, e, i) {
            return i ? void 0 : t[dt.camelCase("default-" + e)] ? e.toLowerCase() : null
        }
    }),
    Ne && Me || (dt.attrHooks.value = {
        set: function(t, e, i) {
            return dt.nodeName(t, "input") ? void(t.defaultValue = e) : Ee && Ee.set(t, e, i)
        }
    }),
    Me || (Ee = {
        set: function(t, e, i) {
    ...
    dt.fn.extend({
        prop: function(t, e) {
            return Pt(this, dt.prop, t, e, arguments.length > 1)
        },
    ...
    dt.extend({
        prop: function(t, e, i) {
            var n, o, s = t.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return 1 === s && dt.isXMLDoc(t) || (e = dt.propFix[e] || e, o = dt.propHooks[e]),
        ...
        propHooks: {
            tabIndex: {
                get: function(t) {
                    ...
                    return e ? parseInt(e, 10) : Le.test(t.nodeName) || $e.test(t.nodeName) && t.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    ct.hrefNormalized || dt.each(["href", "src"],
    function(t, e) {
        dt.propHooks[e] = {
            get: function(t) {
    ...
    dt.fn.extend({
        addClass: function(t) {
            ...
            if ("string" == typeof t && t) for (e = t.match(Dt) || []; i = this[l++];) if (o = q(i), n = 1 === i.nodeType && (" " + o + " ").replace(ze, " ")) {
                for (r = 0; s = e[r++];) n.indexOf(" " + s + " ") < 0 && (n += s + " ");
                o !== (a = dt.trim(n)) && dt.attr(i, "class", a)
            }
            return this
        },
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : dt.isFunction(t) ? this.each(function(i) {
                dt(this).toggleClass(t.call(this, i, q(this), e), e)
            }) : this.each(function() {
                var e, n, o, s;
                if ("string" === i) for (n = 0, o = dt(this), s = t.match(Dt) || []; e = s[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else void 0 !== t && "boolean" !== i || ((e = q(this)) && dt._data(this, "__className__", e), dt.attr(this, "class", e || !1 === t ? "": dt._data(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, i, n = 0;
    ...
    dt.parseJSON = function(e) {
        ...
        var i, n = null,
        o = dt.trim(e + "");
        return o && !dt.trim(o.replace(je,
        function(t, e, o, s) {
            return i && e && (n = 0),
            0 === n ? t: (i = o || e, n += !s - !o, "")
        })) ? Function("return " + o)() : dt.error("Invalid JSON: " + e)
    },
    ...
    dt.extend({
        ...
        ajax: function(e, i) {
            function n(e, i, n, o) {
                var s, h, y, w, x, C = i;
                2 !== b && (b = 2, l && t.clearTimeout(l), c = void 0, a = o || "", T.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, n && (w = V(d, T, n)), w = Q(d, w, T, s), s ? (d.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (dt.lastModified[r] = x), (x = T.getResponseHeader("etag")) && (dt.etag[r] = x)), 204 === e || "HEAD" === d.type ? C = "nocontent": 304 === e ? C = "notmodified": (C = w.state, h = w.data, y = w.error, s = !y)) : (y = C, !e && C || (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (i || C) + "", s ? m.resolveWith(p, [h, C, T]) : m.rejectWith(p, [T, C, y]), T.statusCode(v), v = void 0, u && f.trigger(s ? "ajaxSuccess": "ajaxError", [T, d, s ? h: y]), g.fireWith(p, [T, C]), u && (f.trigger("ajaxComplete", [T, d]), --dt.active || dt.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (i = e, e = void 0),
            i = i || {};
            var o, s, r, a, l, u, c, h, d = dt.ajaxSetup({},
            i),
            p = d.context || d,
            f = d.context && (p.nodeType || p.jquery) ? dt(p) : dt.event,
            m = dt.Deferred(),
            ...
            T = {
                ...
                getResponseHeader: function(t) {
                    var e;
                    if (2 === b) {
                        if (!h) for (h = {}; e = qe.exec(a);) h[e[1].toLowerCase()] = e[2];
                        e = h[t.toLowerCase()]
                    }
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, d.url = ((e || d.url || Ge) + "").replace(We, "").replace(Ye, Ke[1] + "//"), d.type = i.method || i.type || d.method || d.type, d.dataTypes = dt.trim(d.dataType || "*").toLowerCase().match(Dt) || [""], null == d.crossDomain && (o = Ve.exec(d.url.toLowerCase()), d.crossDomain = !(!o || o[1] === Ke[1] && o[2] === Ke[2] && (o[3] || ("http:" === o[1] ? "80": "443")) === (Ke[3] || ("http:" === Ke[1] ? "80": "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = dt.param(d.data, d.traditional)), B(Qe, d, i, T), 2 === b) return T; (u = dt.event && d.global) && 0 == dt.active++&&dt.event.trigger("ajaxStart"),
            d.type = d.type.toUpperCase(),
            d.hasContent = !Be.test(d.type),
            r = d.url,
            d.hasContent || (d.data && (r = d.url += (Fe.test(r) ? "&": "?") + d.data, delete d.data), !1 === d.cache && (d.url = He.test(r) ? r.replace(He, "$1_=" + Re++) : r + (Fe.test(r) ? "&": "?") + "_=" + Re++)),
            d.ifModified && (dt.lastModified[r] && T.setRequestHeader("If-Modified-Since", dt.lastModified[r]), dt.etag[r] && T.setRequestHeader("If-None-Match", dt.etag[r])),
            (d.data && d.hasContent && !1 !== d.contentType || i.contentType) && T.setRequestHeader("Content-Type", d.contentType),
            ...
            for (s in d.headers) T.setRequestHeader(s, d.headers[s]);
            ...
            if (c = B(Xe, d, i, T)) {
                if (T.readyState = 1, u && f.trigger("ajaxSend", [T, d]), 2 === b) return T;
    ...
    function(t, e) {
        dt[e] = function(t, i, n, o) {
            return dt.isFunction(i) && (o = o || n, n = i, i = void 0),
            dt.ajax(dt.extend({
                url: t,
                type: e,
                dataType: o,
    ...
    dt.param = function(t, e) {
        ...
        if (void 0 === e && (e = dt.ajaxSettings && dt.ajaxSettings.traditional), dt.isArray(t) || t.jquery && !dt.isPlainObject(t)) dt.each(t,
        function() {
    ...
    dt.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !dt(this).is(":disabled") && ni.test(this.nodeName) && !ii.test(t) && (this.checked || !Rt.test(t))
            }).map(function(t, e) {
                var i = dt(this).val();
                return null == i ? null: dt.isArray(i) ? dt.map(i,
                function(t) {
                    return {
                        name: e.name,
                        value: t.replace(ei, "\r\n")
    ...
    var oi = 0,
    si = {},
    ri = dt.ajaxSettings.xhr();
    t.attachEvent && t.attachEvent("onunload",
    function() {
        for (var t in si) si[t](void 0, !0)
    }),
    ct.cors = !!ri && "withCredentials" in ri,
    (ri = ct.ajax = !!ri) && dt.ajaxTransport(function(e) {
        if (!e.crossDomain || ct.cors) {
            ...
            return {
                send: function(n, o) {
                    ...
                    i = function(t, n) {
                        var s, l, u;
                        if (i && (n || 4 === r.readyState)) if (delete si[a], i = void 0, r.onreadystatechange = dt.noop, n) 4 !== r.readyState && r.abort();
                        else {
                            u = {},
                            s = r.status,
    ...
    function(t) {
        if (t.crossDomain) {
            var e, i = it.head || dt("head")[0] || it.documentElement;
            return {
                send: function(n, o) { (e = it.createElement("script")).async = !0,
                    t.scriptCharset && (e.charset = t.scriptCharset),
                    e.src = t.url,
                    e.onload = e.onreadystatechange = function(t, i) { (i || !e.readyState || /loaded|complete/.test(e.readyState)) && (e.onload = e.onreadystatechange = null, e.parentNode && e.parentNode.removeChild(e), e = null, i || o(200, "success"))
                    },
    ...
    function(e, i, n) {
        var o, s, r, a = !1 !== e.jsonp && (li.test(e.url) ? "url": "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && li.test(e.data) && "data");
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = dt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(li, "$1" + o) : !1 !== e.jsonp && (e.url += (Fe.test(e.url) ? "&": "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
            return r || dt.error(o + " was not called"),
            r[0]
        },
        ...
        n.always(function() {
            void 0 === s ? dt(t).removeProp(o) : t[o] = s,
            e[o] && (e.jsonpCallback = i.jsonpCallback, ai.push(o)),
            r && dt.isFunction(s) && s(r[0]),
            r = s = void 0
        }), "script") : void 0
    }),
    dt.parseHTML = function(t, e, i) {
        ...
        var n = xt.exec(t),
        o = !i && [];
        return n ? [e.createElement(n[1])] : (n = v([t], e, o), o && o.length && dt(o).remove(), dt.merge([], n.childNodes))
    };
    var ui = dt.fn.load;
    dt.fn.load = function(t, e, i) {
        ...
        var n, o, s, r = this,
        a = t.indexOf(" ");
        return a > -1 && (n = dt.trim(t.slice(a, t.length)), t = t.slice(0, a)),
        dt.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (o = "POST"),
        r.length > 0 && dt.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
    ...
    dt.offset = {
        setOffset: function(t, e, i) {
            var n, o, s, r, a, l, u = dt.css(t, "position"),
            c = dt(t),
            h = {};
            ...
            s = dt.css(t, "top"),
            l = dt.css(t, "left"),
            ("absolute" === u || "fixed" === u) && dt.inArray("auto", [s, l]) > -1 ? (n = c.position(), r = n.top, o = n.left) : (r = parseFloat(s) || 0, o = parseFloat(l) || 0),
            dt.isFunction(e) && (e = e.call(t, i, dt.extend({},
            a))),
    ...
    dt.fn.extend({
        offset: function(t) {
            ...
            o = this[0],
            s = o && o.ownerDocument;
            return s ? (e = s.documentElement, dt.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (n = o.getBoundingClientRect()), i = tt(s), {
    ...
    function(t, e) {
        ...
        dt.fn[t] = function(n) {
            ...
            function(t, n, o) {
                var s = tt(t);
                return void 0 === o ? s ? e in s ? s[e] : s.document.documentElement[n] : t[n] : void(s ? s.scrollTo(i ? dt(s).scrollLeft() : o, i ? o: dt(s).scrollTop()) : t[n] = o)
            },
    ...
    dt.each(["top", "left"],
    function(t, e) {
        dt.cssHooks[e] = O(ct.pixelPosition,
        function(t, i) {
    ...
    function(t, e) {
        ...
        function(i, n) {
            dt.fn[n] = function(n, o) {
                var s = arguments.length && (i || "boolean" != typeof n),
                r = i || (!0 === n || !0 === o ? "margin": "border");
                return Pt(this,
                function(e, i, n) {
                    var o;
                    return dt.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === n ? dt.css(e, i, r) : dt.style(e, i, n, r)
                },
                e, s ? n: void 0, s, null)
            }
        })
    ...
    easeInOutBack: function(t, e, i, n, o, s) {
        return void 0 == s && (s = 1.70158),
        (e /= o / 2) < 1 ? n / 2 * (e * e * ((1 + (s *= 1.525)) * e - s)) + i: n / 2 * ((e -= 2) * e * ((1 + (s *= 1.525)) * e + s) + 2) + i
    },
...
function(t, e, i, n) {
    ...
    u = function() {
        ...
        return "WebkitOpacity" in n && (o = "Webkit"),
    ...
    p = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame ||
    function(t) {
        setTimeout(t, 1e3 / 60)
    };
    o.prototype = {
        ...
        _defineSetters: function() {
            ...
            o = i.setLeft,
            s = i.setTop;
            this._setScrollLeft = "function" == typeof o ?
            function(t) {
                o(e.$scrollElement, t)
            }: t.noop,
            this._setScrollTop = "function" == typeof s ?
            function(t) {
                s(e.$scrollElement, t)
            }: t.noop,
            this._setPosition = n.setPosition ||
            function(t, i, o, s, r) {
                e.options.horizontalScrolling && n.setLeft(t, i, o),
                e.options.verticalScrolling && n.setTop(t, s, r)
            }
        },
        _handleWindowLoadAndResize: function() {
            var i = this,
            n = t(e);
            i.options.responsive && n.bind("load." + this.name,
            function() {
                i.refresh()
            }),
            n.bind("resize." + this.name,
            function() {
                i._detectViewport(),
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                ...
                o = d.data("stellar-vertical-offset") !== n ? d.data("stellar-vertical-offset") : u !== n && u.data("stellar-vertical-offset") !== n ? u.data("stellar-vertical-offset") : e.verticalOffset,
                e.particles.push({
                    $element: d,
                    $offsetParent: u,
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [],
            this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function() {
                var e, r, a, l, u, c, p, f = t(this),
                m = d(f),
                g = 0,
                v = 0,
                y = 0,
                ...
                f.data("stellar-backgroundStartingLeft") ? h(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", m[0]), f.data("stellar-backgroundStartingTop", m[1])),
                ...
                e = f.data("stellar-horizontal-offset") !== n ? f.data("stellar-horizontal-offset") : p !== n && p.data("stellar-horizontal-offset") !== n ? p.data("stellar-horizontal-offset") : i.horizontalOffset,
                r = f.data("stellar-vertical-offset") !== n ? f.data("stellar-vertical-offset") : p !== n && p.data("stellar-vertical-offset") !== n ? p.data("stellar-vertical-offset") : i.verticalOffset,
                i.backgrounds.push({
                    $element: f,
                    $offsetParent: p,
        ...
        _reset: function() {
            var t, e, i, n, o;
            for (o = this.particles.length - 1; o >= 0; o--) t = this.particles[o],
            ...
            for (o = this.backgrounds.length - 1; o >= 0; o--)(n = this.backgrounds[o]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null),
            h(n.$element, n.startingValueLeft, n.startingValueTop)
        },
        destroy: function() {
            this._reset(),
        ...
        _setOffsets: function() {
            ...
            "function" == typeof this.options.horizontalOffset ? (this.horizontalOffset = this.options.horizontalOffset(), n.bind("resize.horizontal-" + this.name,
            function() {
                i.horizontalOffset = i.options.horizontalOffset()
            })) : this.horizontalOffset = this.options.horizontalOffset,
            "function" == typeof this.options.verticalOffset ? (this.verticalOffset = this.options.verticalOffset(), n.bind("resize.vertical-" + this.name,
            function() {
        ...
        _repositionElements: function() {
            ...
            if (this.currentScrollLeft !== c || this.currentScrollTop !== d || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                for (this.currentScrollLeft = c, this.currentScrollTop = d, this.currentWidth = this.viewportWidth, this.currentHeight = this.viewportHeight, u = this.particles.length - 1; u >= 0; u--) t = this.particles[u],
                e = t.isFixed ? 1 : 0,
                this.options.horizontalScrolling ? (s = (c + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft, a = s - t.startingPositionLeft + t.startingOffsetLeft) : (s = t.startingPositionLeft, a = t.startingOffsetLeft),
                this.options.verticalScrolling ? (r = (d + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop, l = r - t.startingPositionTop + t.startingOffsetTop) : (r = t.startingPositionTop, l = t.startingOffsetTop),
                this.options.hideDistantElements && (f = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : c) && a < (t.isFixed ? 0 : c) + this.viewportWidth + this.viewportOffsetLeft, p = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : d) && l < (t.isFixed ? 0 : d) + this.viewportHeight + this.viewportOffsetTop),
                f && p ? (t.isHidden && (this.options.showElement(t.$element), t.isHidden = !1), this._setPosition(t.$element, s, t.startingPositionLeft, r, t.startingPositionTop)) : t.isHidden || (this.options.hideElement(t.$element), t.isHidden = !0);
                for (u = this.backgrounds.length - 1; u >= 0; u--) i = this.backgrounds[u],
                e = i.isFixed ? 0 : 1,
                n = this.options.horizontalScrolling ? (c + i.horizontalOffset - this.viewportOffsetLeft - i.startingOffsetLeft + i.parentOffsetLeft - i.startingBackgroundPositionLeft) * (e - i.stellarRatio) + "px": i.startingValueLeft,
                o = this.options.verticalScrolling ? (d + i.verticalOffset - this.viewportOffsetTop - i.startingOffsetTop + i.parentOffsetTop - i.startingBackgroundPositionTop) * (e - i.stellarRatio) + "px": i.startingValueTop,
                h(i.$element, n, o)
            }
        },
        _handleScrollEvent: function() {
            ...
            this.$scrollElement.bind("scroll." + this.name, n),
            n()
        },
    ...
    t.fn[s] = function(e) {
        ...
        return e === n || "object" == typeof e ? this.each(function() {
            ...
            n instanceof o && "function" == typeof n[e] && n[e].apply(n, Array.prototype.slice.call(i, 1)),
    ...
    t.flexslider = function(i, n) {
        ...
        g = {
            init: function() {
                ...
                (!f || f && o.vars.smoothHeight) && t(window).bind("resize orientationchange focus", g.resize),
            ...
            asNav: {
                setup: function() {
                    ...
                    a ? (i._slider = o, o.slides.each(function() {
                        var e = this;
                    ...
                    function(e) {
                        ...
                        var i = t(this),
                        n = i.index();
                        0 >= i.offset().left - t(o).scrollLeft() && i.hasClass(r + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || i.hasClass(r + "active-slide") || (o.direction = o.currentItem < n ? "next": "prev", o.flexAnimate(n, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    s = 1;
                    if (o.controlNavScaffold = t('<ol class="' + r + "control-nav " + r + n + '"></ol>'), o.pagingCount > 1) for (var a = 0; a < o.pagingCount; a++) {
                        if (void 0 === (i = o.slides.eq(a)).attr("data-thumb-alt") && i.attr("data-thumb-alt", ""), altText = "" !== i.attr("data-thumb-alt") ? altText = ' alt="' + i.attr("data-thumb-alt") + '"': "", e = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"' + altText + "/>": '<a href="#">' + s + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                    ...
                    g.controlNav.set(),
                    g.controlNav.active(),
                    o.controlNavScaffold.delegate("a, img", u,
                    function(e) {
                ...
                update: function(e, i) {
                    o.pagingCount > 1 && "add" === e ? o.controlNavScaffold.append(t('<li><a href="#">' + o.count + "</a></li>")) : 1 === o.pagingCount ? o.controlNavScaffold.find("li").remove() : o.controlNav.eq(i).closest("li").remove(),
                    g.controlNav.set(),
                    o.pagingCount > 1 && o.pagingCount !== o.controlNav.length ? o.update(i, e) : g.controlNav.active()
                }
            },
            directionNav: {
                setup: function() {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav: o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + r + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + r + "direction-nav li a", o)),
                    g.directionNav.update(),
                    o.directionNav.bind(u,
                    function(e) {
                        e.preventDefault();
                        var i; ("" === c || c === e.type) && (i = t(this).hasClass(r + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(i, o.vars.pauseOnAction)),
                        "" === c && (c = e.type),
                        g.setToClearWatchedEvent()
                    })
                },
            ...
            pausePlay: {
                setup: function() {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + r + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + r + "pauseplay a", o)),
                    g.pausePlay.update(o.vars.slideshow ? r + "pause": r + "play"),
                    o.pausePlay.bind(u,
                    function(e) {
                        e.preventDefault(),
                        ("" === c || c === e.type) && (t(this).hasClass(r + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())),
                        "" === c && (c = e.type),
                        g.setToClearWatchedEvent()
                    })
                },
            ...
            touch: function() {
                var t, e, n, s, r, l, u, c, m, g = !1,
                v = 0,
                y = 0,
                w = 0;
                a ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown",
                function(t) {
                    t.stopPropagation(),
                    o.animating ? t.preventDefault() : (o.pause(), i._gesture.addPointer(t.pointerId), w = 0, s = h ? o.h: o.w, l = Number(new Date), n = p && d && o.animatingTo === o.last ? 0 : p && d ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo: p && o.currentSlide === o.last ? o.limit: p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide: d ? (o.last - o.currentSlide + o.cloneOffset) * s: (o.currentSlide + o.cloneOffset) * s)
                },
                !1), i._slider = o, i.addEventListener("MSGestureChange",
                function(t) {
                    t.stopPropagation();
                    ...
                    if (e) {
                        ...
                        return w += h ? a: o,
                        r = w,
                        g = h ? Math.abs(w) < Math.abs( - o) : Math.abs(w) < Math.abs( - a),
                        t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            i._gesture.stop()
                        }) : void((!g || Number(new Date) - l > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (r = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / s + 2 : 1)), e.setProps(n + r, "setTouch"))))
                    }
                },
                !1), i.addEventListener("MSGestureEnd",
                function(i) {
                    i.stopPropagation();
                    var o = i.target._slider;
                    if (o) {
                        if (o.animatingTo === o.currentSlide && !g && null !== r) {
                            var a = d ? -r: r,
                            u = a > 0 ? o.getTarget("next") : o.getTarget("prev");
                            o.canAdvance(u) && (Number(new Date) - l < 550 && Math.abs(a) > 50 || Math.abs(a) > s / 2) ? o.flexAnimate(u, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                        t = null,
                        e = null,
                        r = null,
                ...
                !1)) : (u = function(r) {
                    o.animating ? r.preventDefault() : (window.navigator.msPointerEnabled || 1 === r.touches.length) && (o.pause(), s = h ? o.h: o.w, l = Number(new Date), v = r.touches[0].pageX, y = r.touches[0].pageY, n = p && d && o.animatingTo === o.last ? 0 : p && d ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo: p && o.currentSlide === o.last ? o.limit: p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide: d ? (o.last - o.currentSlide + o.cloneOffset) * s: (o.currentSlide + o.cloneOffset) * s, t = h ? y: v, e = h ? v: y, i.addEventListener("touchmove", c, !1), i.addEventListener("touchend", m, !1))
                },
                c = function(i) {
                    v = i.touches[0].pageX,
                    y = i.touches[0].pageY,
                    r = h ? t - y: t - v; (!(g = h ? Math.abs(r) < Math.abs(v - e) : Math.abs(r) < Math.abs(y - e)) || Number(new Date) - l > 500) && (i.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (r /= 0 === o.currentSlide && 0 > r || o.currentSlide === o.last && r > 0 ? Math.abs(r) / s + 2 : 1), o.setProps(n + r, "setTouch")))
                },
                m = function(a) {
                    if (i.removeEventListener("touchmove", c, !1), o.animatingTo === o.currentSlide && !g && null !== r) {
                        var u = d ? -r: r,
                        h = u > 0 ? o.getTarget("next") : o.getTarget("prev");
                        o.canAdvance(h) && (Number(new Date) - l < 550 && Math.abs(u) > 50 || Math.abs(u) > s / 2) ? o.flexAnimate(h, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                    }
            ...
            resize: function() { ! o.animating && o.is(":visible") && (p || o.doMath(), f ? g.smoothHeight() : p ? (o.slides.width(o.computedW), o.update(o.pagingCount), o.setProps()) : h ? (o.viewport.height(o.h), o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && g.smoothHeight(), o.newSlides.width(o.computedW), o.setProps(o.computedW, "setTotal")))
            },
        ...
        o.flexAnimate = function(e, i, n, s, a) {
            if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next": "prev"), m && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next": "prev"), !o.animating && (o.canAdvance(e, a) || n) && o.is(":visible")) {
                if (m && s) {
                    ...
                    if (o.atEnd = 0 === e || e === o.count - 1, u.flexAnimate(e, !0, !1, !0, a), o.direction = o.currentItem < e ? "next": "prev", u.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e) return o.currentItem = e,
        ...
        o.animateSlides = function() { ! o.animating && e && o.flexAnimate(o.getTarget("next"))
        },
        o.pause = function() {
        ...
        o.setProps = function(t, e, i) {
            ...
            o.transitions && (n = h ? "translate3d(0," + n + ",0)": "translate3d(" + n + ",0,0)", i = void 0 !== i ? i / 1e3 + "s": "0s", o.container.css("-" + o.pfx + "-transition-duration", i), o.container.css("transition-duration", i)),
            o.args[o.prop] = n,
        ...
        o.setup = function(e) {
            ...
            o.vars.smoothHeight && g.smoothHeight();
                ...
                "init" === e && (o.viewport = t('<div class="' + r + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, d && (n = t.makeArray(o.slides).reverse(), o.slides = t(n), o.container.empty().append(o.slides))),
                o.vars.animationLoop && !p && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== e && o.container.find(".clone").remove(), o.container.append(g.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(g.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                o.newSlides = t(o.vars.selector, o),
                i = d ? o.count - 1 - o.currentSlide + o.cloneOffset: o.currentSlide + o.cloneOffset,
                h && !p ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
                    o.newSlides.css({
                        display: "block"
                    }),
                    o.doMath(),
            ...
            p || o.slides.removeClass(r + "active-slide").eq(o.currentSlide).addClass(r + "active-slide"),
            o.vars.init(o)
        },
        o.doMath = function() {
        ...
        o.addSlide = function(e, i) {
            ...
            o.count += 1,
            o.last = o.count - 1,
            h && d ? void 0 !== i ? o.slides.eq(o.count - i).after(n) : o.container.prepend(n) : void 0 !== i ? o.slides.eq(i).before(n) : o.container.append(n),
            o.update(i, "add"),
        ...
        o.removeSlide = function(e) {
            ...
            o.count -= 1,
            o.last = o.count - 1,
            isNaN(e) ? t(e, o.slides).remove() : h && d ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(),
            o.doMath(),
            o.update(i, "remove"),
            o.slides = t(o.vars.selector + ":not(.clone)", o),
            o.setup(),
...
function(t, e) {
    ...
    function o(t, e, s) {
        ...
        this.options), "function" == typeof e ? s = e: i(this.options, e), s && this.on("always", s), this.getImages(), a && (this.jqDeferred = new a.Deferred), void setTimeout(function() {
            this.check()
    ...
    o.makeJQueryPlugin = function(e) { (e = e || t.jQuery) && (a = e, a.fn.imagesLoaded = function(t, e) {
...
function() {
    ...
    function o(o) {
        if (n(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
            ...
            var u = {};
            u.width = o.offsetWidth,
            u.height = o.offsetHeight;
            for (var c = u.isBorderBox = "border-box" == r.boxSizing,
            h = 0; h < l; h++) {
                var d = a[h],
                p = r[d],
                f = parseFloat(p);
            ...
            x = c && s,
            T = t(r.width); ! 1 !== T && (u.width = T + (x ? 0 : m + w));
            var C = t(r.height);
            return ! 1 !== C && (u.height = C + (x ? 0 : g + b)),
            u.innerWidth = u.width - (m + w),
    ...
    var s, r = "undefined" == typeof console ?
    function() {}: function(t) {
        console.error(t)
    },
...
function(t, e) {
    ...
    u.remove = function() {
        s && parseFloat(this.layout.options.transitionDuration) ? (this.once("transitionEnd",
        function() {
            this.removeElem()
...
function(t, e, i, n, o) {
    ...
    p.updateStagger = function() {
        var t = this.options.stagger; {
            if (null !== t && void 0 !== t) return this.stagger = a(t),
            this.stagger;
            this.stagger = 0
        }
    },
    ...
    p.stamp = function(t) { (t = this._find(t)) && (this.stamps = this.stamps.concat(t), t.forEach(this.ignore, this))
    },
...
function(t, e) {
    ...
    i.prototype._getItemLayoutPosition = function(t) {
        ...
        l = s + t.size.outerHeight, u = this.cols + 1 - o.length, c = 0; c < u; c++) this.colYs[r + c] = l;
        return a
    },
...
function(t) {
    ...
    function i(e) {
        ...
        if ("string" === t.type(e.timeFormat) && e.timeFormat.match(/[gh]/) && (e._twelveHourTime = !0), !1 === e.showOnFocus && -1 != e.showOn.indexOf("focus") && e.showOn.splice(e.showOn.indexOf("focus"), 1), e.disableTimeRanges.length > 0) {
            ...
            for (n = e.disableTimeRanges.length - 1; n > 0; n--) e.disableTimeRanges[n][0] <= e.disableTimeRanges[n - 1][1] && (e.disableTimeRanges[n - 1] = [Math.min(e.disableTimeRanges[n][0], e.disableTimeRanges[n - 1][0]), Math.max(e.disableTimeRanges[n][1], e.disableTimeRanges[n - 1][1])], e.disableTimeRanges.splice(n, 1))
        }
        return e
    }
    function n(e) {
        ...
        if (n && n.length && (n.remove(), e.data("timepicker-list", !1)), i.useSelect) var r = n = t("<select />", {
        ...
        if (i.noneOption) if (!0 === i.noneOption && (i.noneOption = i.useSelect ? "Time...": "None"), t.isArray(i.noneOption)) {
            for (var l in i.noneOption) if (parseInt(l, 10) == l) {
                c = o(i.noneOption[l], i.useSelect);
                n.append(c)
            }
        } else {
            var c = o(i.noneOption, i.useSelect);
            n.append(c)
        }
        i.className && r.addClass(i.className),
        null === i.minTime && null === i.durationTime || !i.showDuration || ("function" == typeof i.step || i.step, r.addClass("ui-timepicker-with-duration"), r.addClass("ui-timepicker-step-" + i.step));
        var h = i.minTime;
        "function" == typeof i.durationTime ? h = w(i.durationTime()) : null !== i.durationTime && (h = i.durationTime);
        var p = null !== i.minTime ? i.minTime: 0,
        f = null !== i.maxTime ? i.maxTime: p + x - 1;
        p > f && (f += x),
        f === x - 1 && "string" === t.type(i.timeFormat) && i.show2400 && (f = x);
        ...
        S = 0; f >= l; S++, l += 60 * k(S)) {
            var D = l,
            E = y(D, i);
            if (i.useSelect)(I = t("<option />", {
                value: E
            })).text(E);
            else {
                var I = t("<li />");
                I.addClass(x / 2 > D % x ? "ui-timepicker-am": "ui-timepicker-pm"),
                I.data("time", b(D, i)),
                I.text(E)
            }
            if ((null !== i.minTime || null !== i.durationTime) && i.showDuration) {
                var A = v(l - h, i.step);
                if (i.useSelect) I.text(I.text() + " (" + A + ")");
                else {
                    var O = t("<span />", {
            ...
            C > T && (D >= m[T][1] && (T += 1), m[T] && D >= m[T][0] && D < m[T][1] && (i.useSelect ? I.prop("disabled", !0) : I.addClass("ui-timepicker-disabled"))),
            n.append(I)
        }
        if (r.data("timepicker-input", e), e.data("timepicker-list", r), i.useSelect) e.val() && n.val(s(w(e.val()), i)),
        n.on("focus",
        function() {
        ...
        n.on("change",
        function() {
            d(e, t(this).val(), "select")
        }),
        d(e, n.val(), "initial"),
        e.hide().after(n);
        else {
            var M = i.appendTo;
            "string" == typeof M ? M = t(M) : "function" == typeof M && (M = M(e)),
            M.append(r),
            u(e, n),
            n.on("mousedown click", "li",
            function(i) {
                e.off("focus.timepicker"),
                e.on("focus.timepicker-ie-hack",
                function() {
                    e.off("focus.timepicker-ie-hack"),
                    e.on("focus.timepicker", _.show)
                }),
                a(e) || e[0].focus(),
                n.find("li").removeClass("ui-timepicker-selected"),
                t(this).addClass("ui-timepicker-selected"),
                g(e) && (e.trigger("hideTimepicker"), n.on("mouseup.timepicker click.timepicker", "li",
                function(t) {
                    n.off("mouseup.timepicker click.timepicker"),
                    r.hide()
                }))
            })
        }
    ...
    function o(e, i) {
        var n, o, s;
        return "object" == typeof e ? (n = e.label, o = e.className, s = e.value) : "string" == typeof e ? n = e: t.error("Invalid noneOption value"),
        i ? t("<option />", {
            value: s,
            class: o,
            text: n
    ...
    function s(t, e) {
        return null !== (t = e.roundingFunction(t, e)) ? y(t, e) : void 0
    }
    function r(e) {
        if (e.target != window) {
            var i = t(e.target);
            i.closest(".ui-timepicker-input").length || i.closest(".ui-timepicker-wrapper").length || (_.hide(), t(document).unbind(".ui-timepicker"), t(window).unbind(".ui-timepicker"))
        }
    }
    function a(t) {
    ...
    function l(e, i, n) {
        if (!n && 0 !== n) return ! 1;
        var o = e.data("timepicker-settings"),
        s = !1,
        n = o.roundingFunction(n, o);
        return i.find("li").each(function(e, i) {
            var o = t(i);
            if ("number" == typeof o.data("time")) return o.data("time") == n ? (s = o, !1) : void 0
        }),
        s
    }
    function u(t, e) {
        ...
        if (null !== n) {
            var o = l(t, e, n);
            if (o) {
                var s = o.offset().top - e.offset().top; (s + o.outerHeight() > e.outerHeight() || 0 > s) && e.scrollTop(e.scrollTop() + o.position().top - o.outerHeight()),
                (i.forceRoundTime || o.data("time") === n) && o.addClass("ui-timepicker-selected")
            }
        }
    }
    function c(e, i) {
        if ("timepicker" != i) {
            var n = t(this);
            if ("" === this.value) return void d(n, null, i);
            if (!n.is(":focus") || e && "change" == e.type) {
                var o = n.data("timepicker-settings"),
                s = w(this.value, o);
                if (null === s) return void n.trigger("timeFormatError");
                var r = !1;
                if (null !== o.minTime && null !== o.maxTime && (s < o.minTime || s > o.maxTime) && (r = !0), t.each(o.disableTimeRanges,
                function() {
                    return s >= this[0] && s < this[1] ? (r = !0, !1) : void 0
                }), o.forceRoundTime) {
                    var a = o.roundingFunction(s, o);
                    a != s && (s = a, i = null)
                }
                var l = y(s, o);
                r ? (d(n, l, "error") || e && "change" == e.type) && n.trigger("timeRangeError") : d(n, l, i)
            }
        }
    }
    function h(t) {
    ...
    function d(t, e, i) {
        if (t.is("input")) {
            ...
            n.useSelect && "select" != i && "initial" != i && t.data("timepicker-list").val(s(w(e), n))
        }
        return t.data("ui-timepicker-value") != e ? (t.data("ui-timepicker-value", e), "select" == i ? t.trigger("selectTime").trigger("changeTime").trigger("change", "timepicker") : -1 == ["error", "initial"].indexOf(i) && t.trigger("changeTime"), !0) : (t.trigger("selectTime"), !1)
    }
    function p(t) {
        switch (t.keyCode) {
        case 13:
    ...
    function f(i) {
        ...
        switch (i.keyCode) {
        case 13:
            return g(n) && (c.call(n.get(0), {
                type: "change"
            }), _.hide.apply(this)),
            i.preventDefault(),
            !1;
        case 38:
            var s = o.find(".ui-timepicker-selected");
            return s.length ? s.is(":first-child") || (s.removeClass("ui-timepicker-selected"), s.prev().addClass("ui-timepicker-selected"), s.prev().position().top < s.outerHeight() && o.scrollTop(o.scrollTop() - s.outerHeight())) : (o.find("li").each(function(e, i) {
                return t(i).position().top > 0 ? (s = t(i), !1) : void 0
            }), s.addClass("ui-timepicker-selected")),
            !1;
        case 40:
            return 0 === (s = o.find(".ui-timepicker-selected")).length ? (o.find("li").each(function(e, i) {
                return t(i).position().top > 0 ? (s = t(i), !1) : void 0
            }), s.addClass("ui-timepicker-selected")) : s.is(":last-child") || (s.removeClass("ui-timepicker-selected"), s.next().addClass("ui-timepicker-selected"), s.next().position().top + 2 * s.outerHeight() > o.outerHeight() && o.scrollTop(o.scrollTop() + s.outerHeight())),
            !1;
        case 27:
    ...
    function m(i) {
        ...
        if (!o || !e(o) || s.disableTextInput) return ! 0;
        if ("paste" !== i.type && "cut" !== i.type) switch (i.keyCode) {
        case 96:
        case 97:
        case 98:
        case 99:
        ...
        case 8:
        case 46:
            s.typeaheadHighlight ? u(n, o) : o.hide()
    ...
    function g(t) {
        ...
        return ! n.hasClass("ui-timepicker-disabled") && (n.length && (i = n.data("time")), null !== i && ("string" != typeof i && (i = y(i, e)), d(t, i, "select")), !0)
    }
    function v(t, e) {
        t = Math.abs(t);
        var i, n, o = Math.round(t / 60),
        s = [];
        return 60 > o ? s = [o, T.mins] : (i = Math.floor(o / 60), n = o % 60, 30 == e && 30 == n && (i += T.decimal + 5), s.push(i), s.push(1 == i ? T.hr: T.hrs), 30 != e && n && (s.push(n), s.push(T.mins))),
        s.join(" ")
    }
    function y(e, i) {
        ...
        r = new Date(1970, 0, 2, s, o, n, 0);
        if (isNaN(r.getTime())) return null;
        if ("function" === t.type(i.timeFormat)) return i.timeFormat(r);
        for (var a, l, u = "",
        c = 0; c < i.timeFormat.length; c++) switch (l = i.timeFormat.charAt(c)) {
        case "a":
            u += r.getHours() > 11 ? T.pm: T.am;
            break;
        case "A":
            u += r.getHours() > 11 ? T.PM: T.AM;
            break;
        case "g":
            u += 0 === (a = r.getHours() % 12) ? "12": a;
            break;
        case "G":
            a = r.getHours(),
            e === x && (a = i.show2400 ? 24 : 0),
            u += a;
            break;
        case "h":
            0 !== (a = r.getHours() % 12) && 10 > a && (a = "0" + a),
            u += 0 === a ? "12": a;
            break;
        case "H":
            a = r.getHours(),
            ...
            break;
        case "i":
            u += (o = r.getMinutes()) > 9 ? o: "0" + o;
            break;
        case "s":
            u += (n = r.getSeconds()) > 9 ? n: "0" + n;
            break;
        case "\\":
            c++,
            u += i.timeFormat.charAt(c);
            break;
        default:
            u += l
        }
    ...
    function w(t, e) {
        ...
        if ("string" != typeof t) return t; ("a" == (t = t.toLowerCase().replace(/[\s\.]/g, "")).slice( - 1) || "p" == t.slice( - 1)) && (t += "m");
        var i = "(" + T.am.replace(".", "") + "|" + T.pm.replace(".", "") + "|" + T.AM.replace(".", "") + "|" + T.PM.replace(".", "") + ")?",
        n = new RegExp("^" + i + "([0-9]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?" + i + "$"),
        o = t.match(n);
        if (!o) return null;
        var s = parseInt(1 * o[2], 10),
        r = o[1] || o[5],
        a = s,
        l = 1 * o[3] || 0,
        u = 1 * o[4] || 0;
        if (12 >= s && r) {
            var c = r == T.pm || r == T.PM;
            a = 12 == s ? c ? 12 : 0 : s + (c ? 12 : 0)
        } else if (e && 3600 * s + 60 * l + u >= x + (e.show2400 ? 1 : 0)) {
            if (!1 === e.wrapHours) return null;
            a = s % 24
        }
        var h = 3600 * a + 60 * l + u;
        if (12 > s && !r && e && e._twelveHourTime && e.scrollDefault) {
            var d = h - e.scrollDefault();
            0 > d && d >= x / -2 && (h = (h + x / 2) % x)
        }
        return h
    }
    function b(t, e) {
        return t == x && e.show2400 ? t: t % x
    }
    var x = 86400,
    T = {
        am: "am",
    ...
    _ = {
        init: function(e) {
            return this.each(function() {
                var o = t(this),
                s = [];
                for (var r in C) o.data(r) && (s[r] = o.data(r));
                var a = t.extend({},
                C, e, s);
                if (a.lang && (T = t.extend(T, a.lang)), a = i(a), o.data("timepicker-settings", a), o.addClass("ui-timepicker-input"), a.useSelect) n(o);
                else {
                    if (o.prop("autocomplete", "off"), a.showOn) for (var l in a.showOn) o.on(a.showOn[l] + ".timepicker", _.show);
                    o.on("change.timepicker", c),
                    o.on("keydown.timepicker", f),
                    o.on("keyup.timepicker", m),
                    a.disableTextInput && o.on("keydown.timepicker", p),
                    o.on("cut.timepicker", m),
                    o.on("paste.timepicker", m),
                    c.call(o.get(0), null, "initial")
                }
            })
        },
        show: function(i) {
            var o = t(this),
            s = o.data("timepicker-settings");
            if (i && i.preventDefault(), s.useSelect) o.data("timepicker-list").focus();
            else {
                a(o) && o.blur();
                var c = o.data("timepicker-list");
                if (!o.prop("readonly") && (c && 0 !== c.length && "function" != typeof s.durationTime || (n(o), c = o.data("timepicker-list")), !e(c))) {
                    o.data("ui-timepicker-value", o.val()),
                    u(o, c),
                    _.hide(),
                    c.show();
                    var d = {};
                    s.orientation.match(/r/) ? d.left = o.offset().left + o.outerWidth() - c.outerWidth() + parseInt(c.css("marginLeft").replace("px", ""), 10) : d.left = o.offset().left + parseInt(c.css("marginLeft").replace("px", ""), 10);
                    "t" == (s.orientation.match(/t/) ? "t": s.orientation.match(/b/) ? "b": o.offset().top + o.outerHeight(!0) + c.outerHeight() > t(window).height() + t(window).scrollTop() ? "t": "b") ? (c.addClass("ui-timepicker-positioned-top"), d.top = o.offset().top - c.outerHeight() + parseInt(c.css("marginTop").replace("px", ""), 10)) : (c.removeClass("ui-timepicker-positioned-top"), d.top = o.offset().top + o.outerHeight() + parseInt(c.css("marginTop").replace("px", ""), 10)),
                    c.offset(d);
                    var p = c.find(".ui-timepicker-selected");
                    if (!p.length) {
                        var f = w(h(o));
                        null !== f ? p = l(o, c, f) : s.scrollDefault && (p = l(o, c, s.scrollDefault()))
                    }
                    if ((!p.length || p.hasClass("ui-timepicker-disabled")) && (p = c.find("li:not(.ui-timepicker-disabled):first")), p && p.length) {
                        var m = c.scrollTop() + p.position().top - p.outerHeight();
                        c.scrollTop(m)
                    } else c.scrollTop(0);
                    return s.stopScrollPropagation && t(document).on("wheel.ui-timepicker", ".ui-timepicker-wrapper",
                    function(e) {
                        e.preventDefault();
                        var i = t(this).scrollTop();
                        t(this).scrollTop(i + e.originalEvent.deltaY)
                    }),
                    t(document).on("touchstart.ui-timepicker mousedown.ui-timepicker", r),
                    t(window).on("resize.ui-timepicker", r),
                    s.closeOnWindowScroll && t(document).on("scroll.ui-timepicker", r),
                    o.trigger("showTimepicker"),
                    this
                }
            }
        },
        hide: function(i) {
            var n = t(this),
            o = n.data("timepicker-settings");
            return o && o.useSelect && n.blur(),
            t(".ui-timepicker-wrapper").each(function() {
                var i = t(this);
                if (e(i)) {
                    var n = i.data("timepicker-input"),
                    o = n.data("timepicker-settings");
                    o && o.selectOnBlur && g(n),
                    i.hide(),
                    n.trigger("hideTimepicker")
                }
            }),
            this
        },
        option: function(e, o) {
            return "string" == typeof e && void 0 === o ? t(this).data("timepicker-settings")[e] : this.each(function() {
                var s = t(this),
                r = s.data("timepicker-settings"),
                a = s.data("timepicker-list");
                "object" == typeof e ? r = t.extend(r, e) : "string" == typeof e && (r[e] = o),
                r = i(r),
                s.data("timepicker-settings", r),
                c.call(s.get(0), {
                    type: "change"
                },
                "initial"),
                a && (a.remove(), s.data("timepicker-list", !1)),
                r.useSelect && n(s)
            })
        },
        ...
        setTime: function(t) {
            ...
            if (i.forceRoundTime) n = s(w(t), i);
            else var n = y(w(t), i);
            return t && null === n && i.noneOption && (n = t),
            e.val(n),
            c.call(e.get(0), {
                type: "change"
            },
            "initial"),
            e.data("timepicker-list") && u(e, e.data("timepicker-list")),
            this
        },
        remove: function() {
            var t = this;
            if (t.hasClass("ui-timepicker-input")) {
                var e = t.data("timepicker-settings");
                return t.removeAttr("autocomplete", "off"),
    ...
    t.fn.timepicker = function(e) {
        return this.length ? _[e] ? this.hasClass("ui-timepicker-input") ? _[e].apply(this, Array.prototype.slice.call(arguments, 1)) : this: "object" != typeof e && e ? void t.error("Method " + e + " does not exist on jQuery.timepicker") : _.init.apply(this, arguments) : this
    }
}),
function(t, e) {
    function i() {
    ...
    function s(e, i) {
        ...
        for (var r in n) i.test(r) && (o[r.replace(s,
        function(t, e) {
    ...
    u.prototype = {
        ...
        _process_options: function(e) {
            ...
            !0 !== i.multidate && (i.multidate = Number(i.multidate) || !1, !1 !== i.multidate ? i.multidate = Math.max(0, i.multidate) : i.multidate = 1),
            i.multidateSeparator = String(i.multidateSeparator),
            i.weekStart %= 7,
            i.weekEnd = (i.weekStart + 6) % 7;
            var o = m.parseFormat(i.format);
            i.startDate !== -1 / 0 && (i.startDate ? i.startDate instanceof Date ? i.startDate = this._local_to_utc(this._zero_time(i.startDate)) : i.startDate = m.parseDate(i.startDate, o, i.language) : i.startDate = -1 / 0),
            i.endDate !== 1 / 0 && (i.endDate ? i.endDate instanceof Date ? i.endDate = this._local_to_utc(this._zero_time(i.endDate)) : i.endDate = m.parseDate(i.endDate, o, i.language) : i.endDate = 1 / 0),
            ...
            r && "auto" !== r) if (1 === s.length) switch (s[0]) {
            case "top":
            case "bottom":
                i.orientation.y = s[0];
                break;
        ...
        _applyEvents: function(t) {
            for (var e, i, n, o = 0; o < t.length; o++) e = t[o][0],
            2 === t[o].length ? (i = void 0, n = t[o][1]) : 3 === t[o].length && (i = t[o][1], n = t[o][2]),
            e.on(n, i)
        },
        _unapplyEvents: function(t) {
            for (var e, i, n, o = 0; o < t.length; o++) e = t[o][0],
            2 === t[o].length ? (n = void 0, i = t[o][1]) : 3 === t[o].length && (n = t[o][1], i = t[o][2]),
            e.off(i, n)
        },
        ...
        place: function() {
            if (!this.isInline) {
                ...
                "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (h -= e - c)) : (this.picker.addClass("datepicker-orient-left"), l.left < 0 ? h -= l.left - 10 : l.left + e > n && (h = n - e - 10));
                var p, f, m = this.o.orientation.y;
                "auto" === m && (p = -s + l.top - i, f = s + o - (l.top + u + i), m = Math.max(p, f) === f ? "top": "bottom"),
                this.picker.addClass("datepicker-orient-" + m),
                "top" === m ? d += u: d -= i + parseInt(this.picker.css("padding-top")),
                this.picker.css({
                    top: d,
                    left: h,
                    zIndex: r
        ...
        fillMonths: function() {
            for (var t = "",
            e = 0; e < 12;) t += '<span class="month">' + f[this.o.language].monthsShort[e++] + "</span>";
        ...
        getClassNames: function(e) {
            ...
            this.o.todayHighlight && e.getUTCFullYear() === s.getFullYear() && e.getUTCMonth() === s.getMonth() && e.getUTCDate() === s.getDate() && i.push("today"),
        ...
        fill: function() {
            ...
            this.picker.find("tfoot th.today").text(c).toggle(!1 !== this.o.todayBtn),
            this.picker.find("tfoot th.clear").text(h).toggle(!1 !== this.o.clearBtn),
            this.updateNavArrows(),
            this.fillMonths();
            var d = i(o, s - 1, 28),
            p = m.getDaysInMonth(d.getUTCFullYear(), d.getUTCMonth());
            d.setUTCDate(p),
            d.setUTCDate(p - (d.getUTCDay() - this.o.weekStart + 7) % 7);
            var g = new Date(d);
            g.setUTCDate(g.getUTCDate() + 42),
            g = g.valueOf();
            for (var v, y = []; d.valueOf() < g;) {
                ...
                if ((v = this.getClassNames(d)).push("day"), this.o.beforeShowDay !== t.noop) {
                    var C = this.o.beforeShowDay(this._utc_to_local(d));
                    void 0 === C ? C = {}: "boolean" == typeof C ? C = {
                        enabled: C
                    }: "string" == typeof C && (C = {
                        classes: C
                    }),
                    !1 === C.enabled && v.push("disabled"),
                    C.classes && (v = v.concat(C.classes.split(/\s+/))),
                    C.tooltip && (e = C.tooltip)
                }
                v = t.unique(v),
                y.push('<td class="' + v.join(" ") + '"' + (e ? ' title="' + e + '"': "") + ">" + d.getUTCDate() + "</td>"),
                d.getUTCDay() === this.o.weekEnd && y.push("</tr>"),
                d.setUTCDate(d.getUTCDate() + 1)
            }
            this.picker.find(".datepicker-days tbody").empty().append(y.join(""));
            var _ = this.picker.find(".datepicker-months").find("th:eq(1)").text(o).end().find("span").removeClass("active");
            t.each(this.dates,
            function(t, e) {
                e.getUTCFullYear() === o && _.eq(e.getUTCMonth()).addClass("active")
            }),
            (o < r || o > l) && _.addClass("disabled"),
            o === r && _.slice(0, a).addClass("disabled"),
            o === l && _.slice(u + 1).addClass("disabled"),
            y = "",
            o = 10 * parseInt(o / 10, 10);
            var k = this.picker.find(".datepicker-years").find("th:eq(1)").text(o + "-" + (o + 9)).end().find("td");
            o -= 1;
            for (var S, D = t.map(this.dates,
            function(t) {
                return t.getUTCFullYear()
            }), E = -1; E < 11; E++) S = ["year"],
            -1 === E ? S.push("old") : 10 === E && S.push("new"),
            -1 !== t.inArray(o, D) && S.push("active"),
            (o < r || o > l) && S.push("disabled"),
            y += '<span class="' + S.join(" ") + '">' + o + "</span>",
            o += 1;
            k.html(y)
        },
        ...
        click: function(e) {
            e.preventDefault();
            var n, o, s, r = t(e.target).closest("span, td, th");
            ...
            case "span":
                ...
                break;
            case "td":
                r.is(".day") && !r.is(".disabled") && (s = parseInt(r.text(), 10) || 1, n = this.viewDate.getUTCFullYear(), o = this.viewDate.getUTCMonth(), r.is(".old") ? 0 === o ? (o = 11, n -= 1) : o -= 1 : r.is(".new") && (11 === o ? (o = 0, n += 1) : o += 1), this._setDate(i(n, o, s)))
            }
        ...
        moveMonth: function(t, e) {
            if (t) {
                ...
                (i < 0 || i > 11) && (i = (i + 12) % 12);
                    ...
                    for (var l = 0; l < a; l++) o = this.moveMonth(o, e);
                    i = o.getUTCMonth(),
                    o.setUTCDate(s),
                    n = function() {
        ...
        keydown: function(t) {
            if (this.picker.is(":not(:visible)")) 27 === t.keyCode && this.show();
                ...
                case 39:
                    ...
                    e = 37 === t.keyCode ? -1 : 1,
                    t.ctrlKey ? (i = this.moveYear(this.dates.get( - 1) || n(), e), o = this.moveYear(r, e), this._trigger("changeYear", this.viewDate)) : t.shiftKey ? (i = this.moveMonth(this.dates.get( - 1) || n(), e), o = this.moveMonth(r, e), this._trigger("changeMonth", this.viewDate)) : ((i = new Date(this.dates.get( - 1) || n())).setUTCDate(i.getUTCDate() + e), (o = new Date(r)).setUTCDate(r.getUTCDate() + e)),
                    this.dateWithinRange(i) && (this.focusDate = this.viewDate = o, this.setValue(), this.fill(), t.preventDefault());
                    break;
                case 38:
                case 40:
                    if (!this.o.keyboardNavigation) break;
                    e = 38 === t.keyCode ? -1 : 1,
                    t.ctrlKey ? (i = this.moveYear(this.dates.get( - 1) || n(), e), o = this.moveYear(r, e), this._trigger("changeYear", this.viewDate)) : t.shiftKey ? (i = this.moveMonth(this.dates.get( - 1) || n(), e), o = this.moveMonth(r, e), this._trigger("changeMonth", this.viewDate)) : ((i = new Date(this.dates.get( - 1) || n())).setUTCDate(i.getUTCDate() + 7 * e), (o = new Date(r)).setUTCDate(r.getUTCDate() + 7 * e)),
                    this.dateWithinRange(i) && (this.focusDate = this.viewDate = o, this.setValue(), this.fill(), t.preventDefault());
                    break;
                case 32:
                    break;
        ...
        dateUpdated: function(e) {
            if (!this.updating) {
                ...
                if ( - 1 !== n) {
                    ...
                    }), i < this.dates[n]) for (; n >= 0 && i < this.dates[n];) this.pickers[n--].setUTCDate(i);
                    else if (i > this.dates[n]) for (; n < o && i > this.dates[n];) this.pickers[n++].setUTCDate(i);
                    this.updateDates(),
    ...
    t.fn.datepicker = function(e) {
        ...
        return this.each(function() {
            ...
            if (!a) {
                ...
                f = t.extend({},
                d, p, h, l);
                if (o.is(".input-daterange") || f.inputs) {
                    var m = {
                        inputs: f.inputs || o.find("input").toArray()
                    };
                    o.data("datepicker", a = new c(this, t.extend(f, m)))
                } else o.data("datepicker", a = new u(this, f))
            }
            if ("string" == typeof e && "function" == typeof a[e] && void 0 !== (n = a[e].apply(a, i))) return ! 1
        }),
        void 0 !== n ? n: this
    };
    ...
    m = {
        ...
        parseDate: function(e, n, o) {
            function s() {
                var t = this.slice(0, h[l].length);
                return t === h[l].slice(0, t.length)
            }
            if (e) {
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
                    for (e = new Date, l = 0; l < h.length; l++) switch (r = c.exec(h[l]), a = parseInt(r[1]), r[2]) {
                    case "d":
                        e.setUTCDate(e.getUTCDate() + a);
                        break;
                    case "m":
                        e = u.prototype.moveMonth.call(u.prototype, e, a);
                        break;
                    case "w":
                        e.setUTCDate(e.getUTCDate() + 7 * a);
                        break;
                    case "y":
                        e = u.prototype.moveYear.call(u.prototype, e, a)
                    }
                ...
                y.M = y.MM = y.mm = y.m,
                y.dd = y.d,
                e = i(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0);
                var w = n.parts.slice();
                if (h.length !== w.length && (w = t(w).filter(function(e, i) {
                    return - 1 !== t.inArray(i, v)
                }).toArray()), h.length === w.length) {
                    var b;
                    for (l = 0, b = w.length; l < b; l++) {
                        if (d = parseInt(h[l], 10), r = w[l], isNaN(d)) switch (r) {
                        case "MM":
                            p = t(f[o].months).filter(s),
                            d = t.inArray(p[0], f[o].months) + 1;
                            break;
                        case "M":
                            p = t(f[o].monthsShort).filter(s),
                            d = t.inArray(p[0], f[o].monthsShort) + 1
                        }
                        g[r] = d
                    }
                    var x, T;
                    for (l = 0; l < v.length; l++)(T = v[l]) in g && !isNaN(g[T]) && (x = new Date(e), y[T](x, g[T]), isNaN(x) || (e = x))
                }
                return e
            }
        },
        formatDate: function(e, i, n) {
            ...
            o.mm = (o.m < 10 ? "0": "") + o.m,
            e = [];
            for (var s = t.extend([], i.separators), r = 0, a = i.parts.length; r <= a; r++) s.length && e.push(s.shift()),
            e.push(o[i.parts[r]]);
            return e.join("")
        },
...
function() {
    ...
    return function(t, e, i, n) {
        var o = {
            ...
            detectFeatures: function() {
                ...
                if (i.oldIE = document.all && !document.addEventListener, i.touch = "ontouchstart" in window, window.requestAnimationFrame && (i.raf = window.requestAnimationFrame, i.caf = window.cancelAnimationFrame), i.pointerEvent = navigator.pointerEnabled || navigator.msPointerEnabled, !i.pointerEvent) {
                    ...
                    a = r ? r[1] : 0; (a = parseFloat(a)) >= 1 && (a < 4.4 && (i.isOldAndroid = !0), i.androidVersion = a),
                    i.isMobileOpera = /opera mini|opera mobi/i.test(n)
                }
                for (var l, u, c = ["transform", "perspective", "animationName"], h = ["", "webkit", "Moz", "ms", "O"], d = 0; d < 4; d++) {
                    e = h[d];
                    for (var p = 0; p < 3; p++) l = c[p],
                    u = e + (e ? l.charAt(0).toUpperCase() + l.slice(1) : l),
                    !i[l] && u in t && (i[l] = u);
        ...
        o.features.oldIE && (o.bind = function(t, e, i, n) {
            e = e.split(" ");
            for (var o, s = (n ? "detach": "attach") + "Event", r = 0; r < e.length; r++) if (o = e[r]) if ("object" == typeof i && i.handleEvent) {
                if (n) {
        ...
        o.extend(r, n);
        var a, l, u, c, h, d, p, f, m, g, v, y, w, b, x, T, C, _, k, S, D, E, I, A, O, M, N, L, $, z, P, R, F, j, W, H, q, U, B, Y, V, Q, X, Z, G, K, J, tt, et, it, nt, ot, st, rt, at, lt, ut, ct = {
            x: 0,
            y: 0
        },
        ht = {
        ...
        Et = function(t) {
            at = t,
            s.bg.style.opacity = t * r.bgOpacity
        },
        It = function(t, e, i, n, o) { (!xt || o && o !== s.currItem) && (n /= o ? o.fitRatio: s.currItem.fitRatio),
            t[E] = y + e + "px, " + i + "px" + w + " scale(" + n + ")"
        },
        At = function(t) {
            it && (t && (g > s.currItem.fitRatio ? xt || (ri(s.currItem, !1, !0), xt = !0) : xt && (ri(s.currItem), xt = !1)), It(it, dt.x, dt.y, g))
        },
        Ot = function(t) {
        ...
        Nt = function(t, e) {
            if (!r.loop && e) {
                ...
                n = Math.round(t - fe.x); (i < 0 && n > 0 || i >= Xe() - 1 && n < 0) && (t = fe.x + n * r.mainScrollEndFriction)
            }
            fe.x = t,
            Mt(t, h)
        },
        ...
        Pt = null,
        Rt = function() {
            Pt && (o.unbind(document, "mousemove", Rt), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")),
        ...
        Ft = function() {
            ...
            P.transform && o.bind(s.scrollWrap, "click", s),
        ...
        jt = function() {
            ...
            P.transform && o.unbind(s.scrollWrap, "click", s),
            B && o.unbind(window, p, s),
            clearTimeout(R),
            St("unbindEvents")
        },
        Wt = function(t, e) {
            var i = ii(s.currItem, pt, t);
            return e && (et = i),
            i
        },
        Ht = function(t) {
        ...
        Ut = function(t, e, i, n) {
            return n === s.currItem.initialZoomLevel ? (i[t] = s.currItem.initialPosition[t], !0) : (i[t] = Lt(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
        },
        Bt = function() {
            if (E) {
                var e = P.perspective && !A;
                return y = "translate" + (e ? "3d(": "("),
                void(w = P.perspective ? ", 0px)": ")")
            }
            E = "left",
        ...
        Vt = function(t) {
            t && (Q || V || nt || q) && (t.preventDefault(), t.stopPropagation())
        },
        Qt = function() {
        ...
        Zt = 0,
        Gt = function(t) {
            Xt[t] && (Xt[t].raf && M(Xt[t].raf), Zt--, delete Xt[t])
        },
        Kt = function(t) {
            Xt[t] && Gt(t),
            Xt[t] || (Zt++, Xt[t] = {})
        ...
        Jt = function() {
            for (var t in Xt) Xt.hasOwnProperty(t) && Gt(t)
        },
        te = function(t, e, i, n, o, s, r) {
            var a, l = Dt();
            Kt(t);
            var u = function() {
                if (Xt[t]) {
                    if ((a = Dt() - l) >= n) return Gt(t),
                    s(i),
                    void(r && r());
                    s((i - e) * o(a / n) + e),
                    Xt[t].raf = O(u)
        ...
        ee = {
            ...
            init: function() {
                if (!a && !l) {
                    ...
                    for (P.animationName && P.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < wt.length; i++) s["init" + wt[i]]();
                    e && (s.ui = new e(s, o)).init(),
                    St("firstUpdate"),
                    c = c || r.index || 0,
                    (isNaN(c) || c < 0 || c >= Xe()) && (c = 0),
                    s.currItem = Qe(c),
                    (P.isOldIOSPhone || P.isOldAndroid) && (yt = !1),
                    t.setAttribute("aria-hidden", "false"),
                    r.modal && (yt ? t.style.position = "fixed": (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")),
                    void 0 === z && (St("initialLayout"), z = L = o.getScrollY());
                    var u = "pswp--open ";
                    for (r.mainClass && (u += r.mainClass + " "), r.showHideOpacity && (u += "pswp--animate_opacity "), u += A ? "pswp--touch": "pswp--notouch", u += P.animationName ? " pswp--css_animation": "", u += P.svg ? " pswp--svg": "", o.addClass(t, u), s.updateSize(), d = -1, vt = null, i = 0; i < 3; i++) Mt((i + d) * gt.x, T[i].el.style);
                    ...
                    s.updateCurrItem(),
                    St("afterInit"),
                    yt || (b = setInterval(function() {
                        Zt || B || K || g !== s.currItem.initialZoomLevel || s.updateSize()
                    },
                    1e3)),
            ...
            close: function() {
                a && (a = !1, l = !0, St("close"), jt(), Ge(s.currItem, null, !0, s.destroy))
            },
            destroy: function() {
                St("destroy"),
                Ue && clearTimeout(Ue),
                ...
                t.className = N,
                b && clearInterval(b),
                o.unbind(s.scrollWrap, f, s),
                o.unbind(window, "scroll", s),
                be(),
                Jt(),
                _t = null
            },
            panTo: function(t, e, i) {
                i || (t > et.min.x ? t = et.min.x: t < et.max.x && (t = et.max.x), e > et.min.y ? e = et.min.y: e < et.max.y && (e = et.max.y)),
                dt.x = t,
                dt.y = e,
                At()
            },
            ...
            invalidateCurrItems: function() {
                x = !0;
                for (var t = 0; t < 3; t++) T[t].item && (T[t].item.needsUpdate = !0)
            },
            updateCurrItem: function(t) {
                if (0 !== vt) {
                    ...
                    if (! (t && i < 2)) {
                        ...
                        xt = !1,
                        St("beforeChange", vt),
                        i >= 3 && (d += vt + (vt > 0 ? -3 : 3), i = 3);
                        for (var n = 0; n < i; n++) vt > 0 ? (e = T.shift(), T[2] = e, d++, Mt((d + 2) * gt.x, e.el.style), s.setContent(e, c - i + n + 1 + 1)) : (e = T.pop(), T.unshift(e), d--, Mt(d * gt.x, e.el.style), s.setContent(e, c + i - n - 1 - 1));
                        if (it && 1 === Math.abs(vt)) {
                            var o = Qe(C);
                            o.initialZoomLevel !== g && (ii(o, pt), ri(o), Ot(o))
                        }
                        vt = 0,
            ...
            updateSize: function(e) {
                ...
                if (pt.x = s.scrollWrap.clientWidth, pt.y = s.scrollWrap.clientHeight, Qt(), gt.x = pt.x + Math.round(pt.x * r.spacing), gt.y = pt.y, Nt(gt.x * ft), St("beforeResize"), void 0 !== d) {
                    for (var n, a, l, u = 0; u < 3; u++) n = T[u],
                    Mt((u + d) * gt.x, n.el.style),
                    l = c + u - 1,
                    r.loop && Xe() > 2 && (l = Ct(l)),
                    (a = Qe(l)) && (x || a.needsUpdate || !a.bounds) ? (s.cleanSlide(a), s.setContent(n, l), 1 === u && (s.currItem = a, s.updateCurrZoomItem(!0)), a.needsUpdate = !1) : -1 === n.index && l >= 0 && s.setContent(n, l),
                    a && a.container && (ii(a, pt), ri(a), Ot(a));
                    x = !1
                }
                v = g = s.currItem.initialZoomLevel,
                (et = s.currItem.bounds) && (dt.x = et.center.x, dt.y = et.center.y, At(!0)),
                St("resize")
            },
            zoomTo: function(t, e, i, n, s) {
                e && (v = g, me.x = Math.abs(e.x) - dt.x, me.y = Math.abs(e.y) - dt.y, $t(ht, dt));
                var r = Wt(t, !1),
                a = {};
                Ut("x", r, a, t),
                Ut("y", r, a, t);
                ...
                zt(a);
                var c = function(e) {
                    1 === e ? (g = t, dt.x = a.x, dt.y = a.y) : (g = (t - l) * e + l, dt.x = (a.x - u.x) * e + u.x, dt.y = (a.y - u.y) * e + u.y),
                    s && s(e),
                    At(1 === e)
                };
        ...
        we = function(t, e) {
            return ce.x = Math.abs(t.x - e.x),
            ce.y = Math.abs(t.y - e.y),
        ...
        _e = {},
        ke = function(t, e) {
            return _e.prevent = !Ce(t.target, r.isClickableElement),
            St("preventDragEvent", t, e, _e),
            _e.prevent
        },
        Se = function(t, e) {
            return e.x = t.pageX,
        ...
        Ne = function(t) {
            ...
            return I ? (ut = 0, ae.forEach(function(t) {
                0 === ut ? Me[0] = t: 1 === ut && (Me[1] = t),
                ut++
            })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Me[0] = Se(t.touches[0], Ae), t.touches.length > 1 && (Me[1] = Se(t.touches[1], Oe))) : (Ae.x = t.pageX, Ae.y = t.pageY, Ae.id = "", Me[0] = Ae),
            Me
        },
        Le = function(t, e) {
            ...
            c = fe.x + e.x,
            h = fe.x - le.x;
            return i = l > et.min[t] || l < et.max[t] ? r.panEndFriction: 1,
            l = dt[t] + e[t] * i,
            !r.allowPanToNext && g !== s.currItem.initialZoomLevel || (it ? "h" !== ot || "x" !== t || V || (u ? (l > et.min[t] && (i = r.panEndFriction, et.min[t], n = et.min[t] - ht[t]), (n <= 0 || h < 0) && Xe() > 1 ? (a = c, h < 0 && c > le.x && (a = le.x)) : et.min.x !== et.max.x && (o = l)) : (l < et.max[t] && (i = r.panEndFriction, et.max[t], n = ht[t] - et.max[t]), (n <= 0 || h > 0) && Xe() > 1 ? (a = c, h > 0 && c < le.x && (a = le.x)) : et.min.x !== et.max.x && (o = l))) : a = c, "x" !== t) ? void(nt || Z || g > s.currItem.fitRatio && (dt[t] += e[t] * i)) : (void 0 !== a && (Nt(a, !0), Z = a !== le.x), et.min.x !== et.max.x && (void 0 !== o ? dt.x = o: Z || (dt.x += e.x * i)), void 0 !== a)
        },
        $e = function(t) {
            if (! ("mousedown" === t.type && t.button > 0)) {
                if (Ve) return void t.preventDefault();
                if (!U || "mousedown" !== t.type) {
                    if (ke(t, !0) && t.preventDefault(), St("pointerDown"), I) {
                    ...
                    G = null,
                    Jt(),
                    B && 1 !== n || (B = st = !0, o.bind(window, p, s), H = lt = rt = q = Z = Q = Y = V = !1, ot = null, St("firstTouchStart", i), $t(ht, dt), ct.x = ct.y = 0, $t(se, i[0]), $t(re, se), le.x = gt.x * ft, ue = [{
                        x: se.x,
                        y: se.y
                    }], j = F = Dt(), Wt(g, !0), be(), xe()),
                    !K && n > 1 && !nt && !Z && (v = g, V = !1, K = Y = !0, ct.y = ct.x = 0, $t(ht, dt), $t(ie, i[0]), $t(ne, i[1]), De(ie, ne, ge), me.x = Math.abs(ge.x) - dt.x, me.y = Math.abs(ge.y) - dt.y, J = tt = we(ie, ne))
                }
            }
        },
        ze = function(t) {
            ...
            if (B) {
                ...
                if (ot || Q || K) G = n;
                    ...
                    var s = Math.abs(n[0].x - se.x) - Math.abs(n[0].y - se.y);
                    Math.abs(s) >= 10 && (ot = s > 0 ? "h": "v", G = n)
                }
            }
        },
        Pe = function() {
            if (G) {
                var t = G.length;
                if (0 !== t) if ($t(ie, G[0]), oe.x = ie.x - se.x, oe.y = ie.y - se.y, K && t > 1) {
                    if (se.x = ie.x, se.y = ie.y, !oe.x && !oe.y && ve(G[1], ne)) return;
                    $t(ne, G[1]),
                    V || (V = !0, St("zoomGestureStarted"));
                    var e = we(ie, ne),
                    i = He(e);
                    i > s.currItem.initialZoomLevel + s.currItem.initialZoomLevel / 15 && (lt = !0);
                    var n = 1,
                    o = Ht(),
                    a = qt();
                    if (i < o) if (r.pinchToClose && !lt && v <= s.currItem.initialZoomLevel) {
                        var l = 1 - (o - i) / (o / 1.2);
                        Et(l),
                        St("onPinchClose", l),
                        rt = !0
                    ...
                    if (!ot) return;
                    if (st && (st = !1, Math.abs(oe.x) >= 10 && (oe.x -= G[0].x - re.x), Math.abs(oe.y) >= 10 && (oe.y -= G[0].y - re.y)), se.x = ie.x, se.y = ie.y, 0 === oe.x && 0 === oe.y) return;
                    if ("v" === ot && r.closeOnVerticalDrag && !Te()) {
                        ct.y += oe.y,
                        dt.y += oe.y;
                        var u = Ie();
                        return q = !0,
        ...
        Re = function(t) {
            ...
            St("pointerUp"),
            ke(t, !1) && t.preventDefault();
            var e;
            if (I) {
                var i = o.arraySearch(ae, t.pointerId, "id");
                if (i > -1) if (e = ae.splice(i, 1)[0], navigator.pointerEnabled) e.type = t.pointerType || "mouse";
                else {
                    var n = {
                        4 : "mouse",
                        2 : "touch",
            ...
            var a, l = Ne(t),
            u = l.length;
            if ("mouseup" === t.type && (u = 0), 2 === u) return G = null,
            !0;
            1 === u && $t(re, l[0]),
            0 !== u || ot || nt || (e || ("mouseup" === t.type ? e = {
                x: t.pageX,
                y: t.pageY,
                type: "mouse"
            ...
            var c = -1;
            if (0 === u && (B = !1, o.unbind(window, p, s), be(), K ? c = 0 : -1 !== pe && (c = Dt() - pe)), pe = 1 === u ? Dt() : -1, a = -1 !== c && c < 150 ? "zoom": "swipe", K && u < 2 && (K = !1, 1 === u && (a = "zoomPointerUp"), St("zoomGestureEnded")), G = null, Q || V || nt || q) if (Jt(), W || (W = Fe()), W.calculateSwipeSpeed("x"), q) if (Ie() < r.verticalDragRange) s.close();
            else {
                var h = dt.y,
                d = at;
                te("verticalDrag", 0, 1, 300, o.easing.cubic.out,
                function(t) {
                    dt.y = (s.currItem.initialPosition.y - h) * t + h,
                    Et((1 - d) * t + d),
                    At()
                }),
                St("onVerticalDrag", 1)
                ...
                if (!nt) return "swipe" !== a ? void qe() : void(!Z && g > s.currItem.fitRatio && je(W))
            }
        },
        Fe = function() {
            var t, e, i = {
                ...
                calculateSwipeSpeed: function(n) {
                    ue.length > 1 ? (t = Dt() - j + 50, e = ue[ue.length - 2][n]) : (t = Dt() - F, e = re[n]),
                    i.lastFlickOffset[n] = se[n] - e,
                ...
                calculateOverBoundsAnimOffset: function(t, e) {
                    i.backAnimStarted[t] || (dt[t] > et.min[t] ? i.backAnimDestination[t] = et.min[t] : dt[t] < et.max[t] && (i.backAnimDestination[t] = et.max[t]), void 0 !== i.backAnimDestination[t] && (i.slowDownRatio[t] = .7, i.slowDownRatioReverse[t] = 1 - i.slowDownRatio[t], i.speedDecelerationRatioAbs[t] < .05 && (i.lastFlickSpeed[t] = 0, i.backAnimStarted[t] = !0, te("bounceZoomPan" + t, dt[t], i.backAnimDestination[t], e || 300, o.easing.sine.out,
                    function(e) {
                        dt[t] = e,
                        At()
                    }))))
                ...
                panAnimLoop: function() {
                    if (Xt.zoomPan && (Xt.zoomPan.raf = O(i.panAnimLoop), i.now = Dt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), At(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05)) return dt.x = Math.round(dt.x),
                    dt.y = Math.round(dt.y),
                    At(),
                    void Gt("zoomPan")
                }
            };
        ...
        je = function(t) {
            ...
            t.backAnimStarted = {},
            Math.abs(t.lastFlickSpeed.x) <= .05 && Math.abs(t.lastFlickSpeed.y) <= .05 ? (t.speedDecelerationRatioAbs.x = t.speedDecelerationRatioAbs.y = 0, t.calculateOverBoundsAnimOffset("x"), t.calculateOverBoundsAnimOffset("y"), !0) : (Kt("zoomPan"), t.lastNow = Dt(), void t.panAnimLoop())
        },
        We = function(t, e) {
            var i;
            nt || (he = c);
            ...
            var u;
            n && ((c += n) < 0 ? (c = r.loop ? Xe() - 1 : 0, u = !0) : c >= Xe() && (c = r.loop ? 0 : Xe() - 1, u = !0), u && !r.loop || (vt += n, ft -= n, i = !0));
            var h, d = gt.x * ft,
            p = Math.abs(d - fe.x);
            return i || d > fe.x == e.lastFlickSpeed.x > 0 ? (h = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, h = Math.min(h, 400), h = Math.max(h, 250)) : h = 333,
            he === c && (i = !1),
            nt = !0,
            St("mainScrollAnimStart"),
            te("mainScroll", fe.x, d, h, o.easing.cubic.out, Nt,
            function() {
                Jt(),
                nt = !1,
                he = -1,
                (i || he !== c) && s.updateCurrItem(),
        ...
        qe = function() {
            ...
            g < e ? t = e: g > i && (t = i);
            var n, r = at;
            return rt && !H && !lt && g < e ? (s.close(), !0) : (rt && (n = function(t) {
                Et((1 - r) * t + r)
            ...
            publicMethods: {
                initGestures: function() {
                    var t = function(t, e, i, n, o) {
                        ...
                        S = t + n,
                        D = o ? t + o: ""
                    }; (I = P.pointerEvent) && P.touch && (P.touch = !1),
                    I ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : P.touch ? (t("touch", "start", "move", "end", "cancel"), A = !0) : t("mouse", "down", "move", "up"),
                    p = k + " " + S + " " + D,
                    f = _,
                    I && !A && (A = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
                    s.likelyTouchDevice = A,
                    m[_] = $e,
                    m[k] = ze,
                    m[S] = Re,
                    D && (m[D] = m[S]),
                    P.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[_], m.mousemove = m[k], m.mouseup = m[S]),
                    A || (r.allowPanToNext = !1)
                }
            }
        });
        var Ue, Be, Ye, Ve, Qe, Xe, Ze, Ge = function(e, i, n, a) {
            Ue && clearTimeout(Ue),
            Ve = !0,
            Ye = !0;
            var l;
            e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(c);
            var h = n ? r.hideAnimationDuration: r.showAnimationDuration,
            d = function() {
                Gt("initialZoom"),
                n ? (s.template.removeAttribute("style"), s.bg.removeAttribute("style")) : (Et(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd": "InEnd"))),
                a && a(),
                Ve = !1
            };
            if (!h || !l || void 0 === l.x) return St("initialZoom" + (n ? "Out": "In")),
            g = e.initialZoomLevel,
            $t(dt, e.initialPosition),
            At(),
            ...
            function() {
                ...
                n || (g = l.w / e.w, dt.x = l.x, dt.y = l.y - L, s[a ? "template": "bg"].style.opacity = .001, At()),
                Kt("initialZoom"),
                n && !i && o.removeClass(t, "pswp--animated-in"),
                a && (n ? o[(i ? "remove": "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                ...
                Ue = setTimeout(function() {
                    if (St("initialZoom" + (n ? "Out": "In")), n) {
                        ...
                        c = at,
                        p = function(e) {
                            1 === e ? (g = s, dt.x = l.x, dt.y = l.y - z) : (g = (s - u) * e + u, dt.x = (l.x - r.x) * e + r.x, dt.y = (l.y - z - r.y) * e + r.y),
                            At(),
                            a ? t.style.opacity = 1 - e: Et(c - e * c)
                        };
                        i ? te("initialZoom", 0, 1, h, o.easing.cubic.out, p, d) : (p(1), Ue = setTimeout(d, h + 20))
                    } else g = e.initialZoomLevel,
                    $t(dt, e.initialPosition),
                    At(),
                    Et(1),
                    a ? t.style.opacity = 1 : Et(1),
                    Ue = setTimeout(d, h + 20)
                },
                n ? 25 : 90)
            } ()
        },
        ...
        ei = function(t, e, i) {
            ...
            n.max.y = i > Ke.y ? Math.round(Ke.y - i) + t.vGap.top: n.center.y,
        ...
        ni = function(t, e, i, n, o, r) {
            e.loadError || n && (e.imageAppended = !0, ri(e, n, e === s.currItem && xt), i.appendChild(n), r && setTimeout(function() {
        ...
        si = function(t, e) {
            if (t.src && t.loadError && t.container) return e && (t.container.innerHTML = ""),
        ...
        ri = function(t, e, i) {
            if (t.src) {
                ...
                t.placeholder && !t.loaded && (t.placeholder.style.width = n + "px", t.placeholder.style.height = o + "px"),
                e.style.width = n + "px",
                e.style.height = o + "px"
            }
        },
            ...
            publicMethods: {
                ...
                initController: function() {
                    ...
                    function(t) {
                        ...
                        o = Math.min(i[0], Xe()),
                        a = Math.min(i[1], Xe());
                        for (e = 1; e <= (n ? a: o); e++) s.lazyLoadItem(c + e);
                    ...
                    kt("mainScrollAnimComplete", ai),
                    kt("initialZoomInEnd", ai),
                    kt("destroy",
                    function() {
                        for (var t, e = 0; e < Be.length; e++)(t = Be[e]).container && (t.container = null),
                ...
                setContent: function(t, e) {
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? u.appendChild(l.html) : u.innerHTML = l.html), si(l), ii(l, pt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (n = o.createEl("pswp__img", "img"), n.style.opacity = 1, n.src = l.src, ri(l, n), ni(0, l, u, n));
                        else {
                            if (l.loadComplete = function(i) {
                                if (a) {
                                    if (t && t.index === e) {
                                        if (si(i, !0)) return i.loadComplete = i.img = null,
                                        ii(i, pt),
                                        Ot(i),
                                        void(t.index === c && s.updateCurrZoomItem());
                                        i.imageAppended ? !Ve && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : P.transform && (nt || Ve) ? Je.push({
                                            item: i,
                                            baseDiv: u,
                                            img: i.img,
                                            index: e,
                            ...
                            l.loading || oi(l),
                            s.allowProgressiveImg() && (!Ye && P.transform ? Je.push({
                                item: l,
                                baseDiv: u,
                                img: l.img,
                                index: e,
                        ...
                        Ye || e !== c ? Ot(l) : (it = u.style, Ge(l, n || l.img)),
                        t.el.innerHTML = "",
                        t.el.appendChild(u)
                    } else t.el.innerHTML = ""
                },
        ...
        Tt("Tap", {
            publicMethods: {
                initTap: function() {
                    kt("firstTouchStart", s.onTapStart),
                    kt("touchRelease", s.onTapRelease),
                    kt("destroy",
                    function() {
                        ui = {},
                        li = null
        ...
        Tt("DesktopZoom", {
            publicMethods: {
                ...
                setupDesktopZoom: function(e) {
                    ...
                    kt("unbindEvents",
                    function() {
                        hi && o.unbind(t, i, s.handleMouseWheel)
                    }),
                    s.mouseZoomedIn = !1;
                    var n, r = function() {
                        s.mouseZoomedIn && (o.removeClass(t, "pswp--zoomed-in"), s.mouseZoomedIn = !1),
                ...
                handleMouseWheel: function(t) {
                    if (g <= s.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Zt || B ? t.preventDefault() : E && Math.abs(t.deltaY) > 2 && (u = !0, s.close())),
                    !0;
                    if (t.stopPropagation(), hi.x = 0, "deltaX" in t) 1 === t.deltaMode ? (hi.x = 18 * t.deltaX, hi.y = 18 * t.deltaY) : (hi.x = t.deltaX, hi.y = t.deltaY);
                    else if ("wheelDelta" in t) t.wheelDeltaX && (hi.x = -.16 * t.wheelDeltaX),
                    t.wheelDeltaY ? hi.y = -.16 * t.wheelDeltaY: hi.y = -.16 * t.wheelDelta;
                    else {
                    ...
                    Wt(g, !0);
                    var e = dt.x - hi.x,
                    i = dt.y - hi.y; (r.modal || e <= et.min.x && e >= et.max.x && i <= et.min.y && i >= et.max.y) && t.preventDefault(),
                    s.panTo(e, i)
                },
        ...
        var di, pi, fi, mi, gi, vi, yi, wi, bi, xi, Ti, Ci, _i = {
            history: !0,
            galleryUID: 1
        },
        ki = function() {
            return Ti.hash.substring(1)
        },
        Si = function() {
            di && clearTimeout(di),
            fi && clearTimeout(fi)
        ...
        Di = function() {
            ...
            if (r.galleryPIDs) {
                var s = e.pid;
                for (e.pid = 0, i = 0; i < Be.length; i++) if (Be[i].pid === s) {
                    e.pid = i;
                    break
                }
        ...
        Ei = function() {
            if (fi && clearTimeout(fi), Zt || B) fi = setTimeout(Ei, 500);
            else {
                mi ? clearTimeout(pi) : mi = !0;
                var t = c + 1,
                e = Qe(c);
                e.hasOwnProperty("pid") && (t = e.pid);
                var i = yi + "&gid=" + r.galleryUID + "&pid=" + t;
                wi || -1 === Ti.hash.indexOf(i) && (xi = !0);
                var n = Ti.href.split("#")[0] + "#" + i;
                Ci ? "#" + i !== window.location.hash && history[wi ? "replaceState": "pushState"]("", document.title, n) : wi ? Ti.replace(n) : Ti.hash = i,
                wi = !0,
            ...
            publicMethods: {
                initHistory: function() {
                    if (o.extend(r, _i, !0), r.history) {
                        ...
                        yi.indexOf("gid=") > -1 && (yi = yi.split("&gid=")[0], yi = yi.split("?gid=")[0]),
                        kt("afterChange", s.updateURL),
                        kt("unbindEvents",
                        function() {
                        ...
                        var t = function() {
                            vi = !0,
                            bi || (xi ? history.back() : yi ? Ti.hash = yi: Ci ? history.pushState("", document.title, Ti.pathname + Ti.search) : Ti.hash = ""),
                            Si()
                        };
                        kt("unbindEvents",
                        function() {
                        ...
                        e > -1 && "&" === (yi = yi.substring(0, e)).slice( - 1) && (yi = yi.slice(0, -1)),
                        setTimeout(function() {
                ...
                onHashChange: function() {
                    return ki() === yi ? (bi = !0, void s.close()) : void(mi || (gi = !0, s.goTo(Di().pid), gi = !1))
                },
                updateURL: function() {
                    Si(),
                    gi || (wi ? di = setTimeout(Ei, 800) : Ei())
                }
            }
        }),
        o.extend(s, ee)
...
function() {
    "use strict";
    return function(t, e) {
        var i, n, o, s, r, a, l, u, c, h, d, p, f, m, g, v, y, w, b, x = this,
        T = !1,
        C = !0,
        _ = !0,
        k = {
        ...
        S = function(t) {
            ...
            for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", s = 0; s < U.length; s++)(i = U[s]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
            if (n) {
        ...
        M = function(e) {
            ...
            !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), _ || O(), 1))
        },
        N = function() {
            for (var t, e, i, n, o, s = "",
            r = 0; r < g.shareButtons.length; r++) t = g.shareButtons[r],
            i = g.getImageURLForShare(t),
            n = g.getPageURLForShare(t),
            o = g.getTextForShare(t),
            e = t.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(i)).replace("{{raw_image_url}}", i).replace("{{text}}", encodeURIComponent(o)),
            s += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download": "") + ">" + t.label + "</a>",
        ...
        F = function() {
            g.preloaderEl && (j(!0), h("beforeChange",
            function() {
                clearTimeout(f),
        ...
        j = function(t) {
            p !== t && (E(d, "preloader--active", !t), p = t)
        },
        W = function(t) {
            var i = t.vGap;
            if (D()) {
                var r = g.barsSize;
                if (g.captionEl && "auto" === r.bottom) if (s || ((s = e.createEl("pswp__caption pswp__caption--fake")).appendChild(e.createEl("pswp__caption__center")), n.insertBefore(s, o), e.addClass(n, "pswp__ui--fit")), g.addCaptionHTMLFn(t, s, !0)) {
        ...
        H = function() {
            g.timeToIdle && h("mouseUsed",
            function() {
                e.bind(document, "mousemove", z),
                e.bind(document, "mouseout", P),
        ...
        B = function() {
            var t, i, o, s = function(n) {
                if (n) for (var s = n.length,
                r = 0; r < s; r++) {
                    t = n[r],
                    i = t.className;
                    for (var a = 0; a < U.length; a++) o = U[a],
                    i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                }
            };
            s(n.children);
        ...
        x.init = function() {
            ...
            h("destroy",
            function() {
                g.captionEl && (s && n.removeChild(s), e.removeClass(o, "pswp__caption--empty")),
        ...
        x.update = function() {
            C && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), E(o, "caption--empty", !t.currItem.title)), T = !0) : T = !1,
            _ || O(),
            I()
        },
        ...
        x.onGlobalTap = function(i) {
            ...
            } else if (g.tapToToggleControls && (C ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || L(n))) return void t.close()
        },
        x.onMouseOver = function(t) {
            var e = (t = t || window.event).target || t.srcElement;
            E(n, "ui--over-close", L(e))
        },
...
function(t, e, i, n) {
    ...
    function r(t) {
        ...
        s = t;
        for (e in s) if (n = s[e], void 0 !== o.style[n]) return o = null,
        [n, e];
        return [!1]
    }
    function a() {
    ...
    },
    {
        ...
        run: function() {
            var t = this._clones; (this.$stage.children(".cloned").length !== t.length || !this.settings.loop && t.length > 0) && (this.$stage.children(".cloned").remove(), this._clones = [])
        }
    },
    {
        filter: ["items", "settings"],
    ...
    },
    {
        ...
        run: function() {
            ...
            o[this.settings.rtl ? "margin-left": "margin-right"] = this.settings.margin, !this.settings.autoWidth && t.grep(this._mergers,
            function(t) {
                return t > 1
            }).length > 0) for (e = 0, i = this._coordinates.length; i > e; e++) o.width = Math.abs(this._coordinates[e]) - Math.abs(this._coordinates[e - 1] || 0) - this.settings.margin,
    ...
    o.prototype.initialize = function() {
        if (this.trigger("initialize"), this.$element.addClass(this.settings.baseClass).addClass(this.settings.themeClass).toggleClass("owl-rtl", this.settings.rtl), this.browserSupport(), this.settings.autoWidth && !0 !== this.state.imagesLoaded) {
            var e, i, o;
            if (e = this.$element.find("img"), i = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector: n, o = this.$element.children(i).width(), e.length && 0 >= o) return this.preloadAutoWidthImages(e),
            !1
        }
    ...
    o.prototype.setup = function() {
        ...
        this.options, i[n]), delete o.responsive, o.responsiveClass && this.$element.attr("class",
        function(t, e) {
    ...
    o.prototype.update = function() {
        ...
        this._invalidated), o = {}; i > e;)(this._invalidated.all || t.grep(this._pipe[e].filter, n).length > 0) && this._pipe[e].run(o),
        e++;
        this._invalidated = {}
    },
    ...
    o.prototype.closest = function(e) {
        ...
        return this.settings.freeDrag || t.each(o, t.proxy(function(t, s) {
            return e > s - 30 && s + 30 > e ? i = t: this.op(e, "<", s) && this.op(e, ">", o[t + 1] || s - n) && (i = "left" === this.state.direction ? t + 1 : t),
            -1 === i
        },
        this)),
    ...
    o.prototype.reset = function(t) { (t = this.normalize(t)) !== n && (this._speed = 0, this._current = t, this.suppress(["translate", "translated"]), this.animate(this.coordinates(t)), this.release(["translate", "translated"]))
    },
    ...
    o.prototype.to = function(i, n) {
        if (this.settings.loop) {
            ...
            a < this.settings.items && !1 === l ? (s = r + this._items.length, this.reset(s)) : a >= u - this.settings.items && !0 === l && (s = r - this._items.length, this.reset(s)),
            e.clearTimeout(this.e._goToLoop),
            this.e._goToLoop = e.setTimeout(t.proxy(function() {
                this.speed(this.duration(this.current(), s + o, n)),
                this.current(s + o),
                this.update()
            },
            this), 30)
    ...
    o.prototype.remove = function(t) { (t = this.normalize(t, !0)) !== n && (this.trigger("remove", {
    ...
    var i = function(e) {
        ...
        this._handlers = {
            "initialized.owl.carousel change.owl.carousel": t.proxy(function(e) {
                ...
                n = i.center && Math.ceil(i.items / 2) || i.items, o = i.center && -1 * n || 0, s = (e.property && e.property.value || this._core.current()) + o, r = this._core.clones().length, a = t.proxy(function(t, e) {
                    this.load(e)
                },
                this); o++<n;) this.load(r / 2 + this._core.relative(s)),
...
function(t, e, i) {
    ...
    n.prototype.thumbnail = function(e, i) {
        ...
        a.length ? (h(a.attr(l)), a.remove(), !1) : void("youtube" === i.type ? (s = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg", h(s)) : "vimeo" === i.type && t.ajax({
            type: "GET",
    ...
    i.prototype.slide = function(e, n) {
        ...
        if (this.$element.trigger(c), !c.isDefaultPrevented()) {
            ...
            function() {
                ...
                0)
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (o.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(d)),
            r && this.cycle(),
            this
        }
    };
...
function(t) {
    ...
    function i(e) {
        return this.each(function() {
            ...
            s = t.extend({},
            n.DEFAULTS, i.data(), "object" == typeof e && e); ! o && s.toggle && /show|hide/.test(e) && (s.toggle = !1),
...
function(t) {
    ...
    e.prototype.applyPlacement = function(e, i) {
        ...
        d = h ? 2 * c.left - o + l: 2 * c.top - s + u,
        p = h ? "offsetWidth": "offsetHeight";
        n.offset(e),
        this.replaceArrow(d, n[0][p], h)
    },
    ...
    e.prototype.hide = function(i) {
        ...
        if (this.$element.trigger(r), !r.isDefaultPrevented()) return s.removeClass("in"),
    ...
    t.fn.tooltip = function(i) {
        return this.each(function() {
            var n = t(this),
            o = n.data("bs.tooltip"),
            s = "object" == typeof i && i; ! o && /destroy|hide/.test(i) || (o || n.data("bs.tooltip", o = new e(this, s)), "string" == typeof i && o[i]())
        })
    },
...
function(t) {
    ...
    t.fn.popover = function(i) {
        return this.each(function() {
            var n = t(this),
            o = n.data("bs.popover"),
            s = "object" == typeof i && i; ! o && /destroy|hide/.test(i) || (o || n.data("bs.popover", o = new e(this, s)), "string" == typeof i && o[i]())
        })
    },
...
function() {
    ...
    e.prototype.createThrottledScrollHandler = function() {
        ...
        function() { (!e.didScroll || o.isTouch) && (e.didScroll = !0, o.requestAnimationFrame(t))
        })
    },
    ...
    e.prototype.handleScroll = function() {
        ...
        for (var i in e) {
            ...
            for (var s in this.waypoints[i]) {
                ...
                u = a && l,
                c = !a && !l; (u || c) && (r.queueTrigger(o), t[r.group.id] = r.group)
            }
        }
    ...
    e.prototype.refresh = function() {
        ...
        for (var s in t) {
            ...
            for (var a in this.waypoints[s]) {
                ...
                h = u && c,
                d = !u && !c,
                !v && h ? (p.queueTrigger(r.backward), n[p.group.id] = p.group) : !v && d ? (p.queueTrigger(r.forward), n[p.group.id] = p.group) : v && r.oldScroll >= p.triggerPoint && (p.queueTrigger(r.forward), n[p.group.id] = p.group)
            }
        }
    ...
    o.requestAnimationFrame = function(e) { (window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || t).call(window, e)
    },
    o.Context = e
} (),
function() {
    ...
    i.prototype.flushTriggers = function() {
        for (var i in this.triggerQueues) {
            ...
            for (var s = 0,
            r = n.length; r > s; s += 1) {
                var a = n[s]; (a.options.continuous || s === n.length - 1) && a.trigger([i])
            }
        }
        this.clearTriggerQueues()
    },
...
function() {
    ...
    function t(t) {
        return function() {
            var i = [],
            n = arguments[0];
            return t.isFunction(arguments[0]) && (n = t.extend({},
            arguments[1]), n.handler = arguments[0]),
            this.each(function() {
                var o = t.extend({},
                n, {
                    element: this
